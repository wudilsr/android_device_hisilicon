...
LIBSF_SRC := \
    libsf/libsf.cpp \
    libsf/QCOM_ColorCvt.cpp

FF_AVCODEC_SRC := \
    libavcodec/libstagefright_h264.c \
    libavcodec/4xm.c \
    libavcodec/8bps.c \
    libavcodec/8svx.c \
...
LOCAL_C_INCLUDES += \
    ...
    /root/froyo/external/opencore/extern_libs_v2/khronos/openmax/include
...
LOCAL_MODULE := libHWAHStreaming

LOCAL_C_INCLUDES += \
    $(LOCAL_PATH) \
    $(LOCAL_PATH)/libHWAHStreaming/include
