...
LIBAV_CONFIG_MAK=1
LIBAV_CONFIGURATION=--target-os=linux --arch=armv7-a --enable-static --enable-version3 --enable-gpl --enable-nonfree --enable-network --enable-memalign-hack --disable-debug --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --disable-devices --disable-avfilter --disable-avdevice --disable-zlib --enable-cross-compile --cross-prefix=arm-linux-androideabi- --cc='D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc' --cross-prefix='D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-' --sysroot='D:/android-ndk-r7b/platforms/android-14/arch-arm' --sysinclude='D:/android-ndk-r7b/platforms/android-14/arch-arm/usr/include' --nm='D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-nm' --extra-cflags=' -O3 -march=armv7-a -mtune=cortex-a9 -mfpu=neon -ffast-math -mfloat-abi=softfp -ftree-vectorize -mvectorize-with-neon-quad -fsingle-precision-constant -mlong-calls -fstrict-aliasing -fprefetch-loop-arrays -fPIC -DANDROID' --extra-ldflags='-Wl,-T,D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=D:/android-ndk-r7b/platforms/android-14/arch-arm/usr/lib -LD:/android-ndk-r7b/platforms/android-14/arch-arm/usr/lib -nostdlib D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl'
prefix=/usr/local
...
SRC_PATH="/cygdrive/e/EATAPlayer/ahPlayer_r14467_mt_software_noopendemux_FMO_Neon_Wudi/ahplayer-jni/jni/libffmpeg"
SRC_PATH_BARE=/cygdrive/e/EATAPlayer/ahPlayer_r14467_mt_software_noopendemux_FMO_Neon_Wudi/ahplayer-jni/jni/libffmpeg
BUILD_ROOT="/cygdrive/e/EATAPlayer/ahPlayer_r14467_mt_software_noopendemux_FMO_Neon_Wudi/ahplayer-jni/jni/libffmpeg"
CC_IDENT=gcc 4.4.3 (GCC)
ARCH=arm
CC=D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
AS=D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ar
RANLIB=D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ranlib
LN_S=ln -sf
CPPFLAGS= --sysroot=D:/android-ndk-r7b/platforms/android-14/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -O3 -march=armv7-a -mtune=cortex-a9 -mfpu=neon -ffast-math -mfloat-abi=softfp -ftree-vectorize -mvectorize-with-neon-quad -fsingle-precision-constant -mlong-calls -fstrict-aliasing -fprefetch-loop-arrays -fPIC -DANDROID  -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -O3 -march=armv7-a -mtune=cortex-a9 -mfpu=neon -ffast-math -mfloat-abi=softfp -ftree-vectorize -mvectorize-with-neon-quad -fsingle-precision-constant -mlong-calls -fstrict-aliasing -fprefetch-loop-arrays -fPIC -DANDROID  -fPIC
CC_O=-o $@
DLLTOOL=
LDFLAGS= -Wl,-T,D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=D:/android-ndk-r7b/platforms/android-14/arch-arm/usr/lib -LD:/android-ndk-r7b/platforms/android-14/arch-arm/usr/lib -nostdlib D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o D:/android-ndk-r7b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl --sysroot=D:/android-ndk-r7b/platforms/android-14/arch-arm -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
