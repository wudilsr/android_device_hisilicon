...
static int read_seek(AVFormatContext *s, int stream_index, int64_t target_ts, int flags){
    ...
    if(g_pAHS)
    {
        ...
        int64_t dts = av_rescale(target_ts, AV_TIME_BASE * (int64_t)st->time_base.num, st->time_base.den);
