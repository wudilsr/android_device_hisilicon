...
typedef enum hiFORMAT_INVOKE_ID_E
{
    ...
    HI_FORMAT_INVOKE_GET_URL_INFO,         /**< the command of getting URL information, the parameter is ::HI_FORMAT_URL_INFO_S */ /**< CNcomment:获取URL信息，参数类型为::HI_FORMAT_URL_INFO_S */
    ...
    HI_FORMAT_INVOKE_SET_HLS_FRESH_URL,
...
typedef struct hiFORMAT_MSG_DATA_S
{
    HI_S32 s32Param1;
    HI_S32 s32Param2;
    HI_S32 s32Param3;
...
typedef struct hiFORMAT_MSG_S
{
    ...
    HI_FORMAT_MSG_DATA_S      stData;  /**< the data of other msgs' *//**< CNcomment:其它消息的数据::HI_FORMAT_MSG_DATA_S */
} HI_FORMAT_MSG_S;
