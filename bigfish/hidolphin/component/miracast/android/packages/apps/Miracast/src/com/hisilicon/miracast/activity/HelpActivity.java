...
public class HelpActivity extends BaseActivity
{
    ...
    protected void initView()
    {
        ...
        mViewFlipper.addView(mInflater.inflate(R.layout.activity_help_1, null));
        mViewFlipper.addView(mInflater.inflate(R.layout.activity_help_2, null));
        mViewFlipper.addView(mInflater.inflate(R.layout.activity_help_3, null));
        mViewFlipper.addView(mInflater.inflate(R.layout.activity_help_4, null));
