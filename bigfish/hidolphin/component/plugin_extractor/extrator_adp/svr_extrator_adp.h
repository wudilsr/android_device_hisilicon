#ifndef _SVR_EXTRATOR_ADP_H_

#define _SVR_EXTRATOR_ADP_H_
...
struct SVRExtratorAdp {
    ...
    status_t readFrame(HI_FORMAT_FRAME_S *frame);
    status_t freeFrame(HI_FORMAT_FRAME_S *frame);
    status_t invoke (HI_U32 u32InvokeId, HI_VOID *pArg);
...
private:
    ...
    uint32_t  mVideoTrackIndex;
    uint32_t  mAudioTrackIndex;
    uint32_t  mVideoReadTimes;
    uint32_t  mAudioReadTimes;
    int64_t   mLastAudioFramePts;
    int64_t   mLastVideoFramePts;
    bool mbVideoEndOfStream;
    bool mbAudioEndOfStream;
