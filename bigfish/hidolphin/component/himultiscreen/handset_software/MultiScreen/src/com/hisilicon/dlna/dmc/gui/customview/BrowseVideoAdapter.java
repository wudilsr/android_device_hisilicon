...
public class BrowseVideoAdapter extends AbsListViewAdapter<PlaylistItem> {
	private Context context;
	private LayoutInflater m_inflater = null;
	private static Bitmap BM_VIDEO;

	public BrowseVideoAdapter(Context theContext) {
		context = theContext;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		{
			convertView = m_inflater.inflate(R.layout.dlna_dms_browsevideo_item, null, false);
		}
	...
	private void initVideoItem(int position, DIDLObject object, ViewHolder holder)
	{
		...
		String time = res != null ? res.getDuration() : "0";
		holder.subtitle.setText(Utility.timeStringToMinute(time) + Utility.getString(R.string.minute));
