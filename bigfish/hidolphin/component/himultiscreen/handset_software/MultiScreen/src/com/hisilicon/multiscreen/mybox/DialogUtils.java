...
public class DialogUtils
{
        ...
        DialogInterface.OnClickListener listener)
    {
        ...
        String enterOk = ctx.getResources().getString(R.string.OK);
    ...
    public static void showToast(String message, Context ctx)
    {
        ...
        frameLayout.addView(linearLayout, new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
            LayoutParams.WRAP_CONTENT));
        ...
        DialogInterface.OnDismissListener dismissListener)
    {
        ...
        String enterOk = ctx.getResources().getString(R.string.dialogOK);
        AlertDialog.Builder builder = new Builder(ctx);
        ...
        DialogInterface.OnClickListener okListener, DialogInterface.OnClickListener cancleListener)
    {
        ...
        String enterOk = ctx.getResources().getString(R.string.dialogOK);
        String enterCancle = ctx.getResources().getString(R.string.dialogCancel);
        AlertDialog.Builder builder = new Builder(ctx);
     ...
     * @param listener - click listener
     */
    public static Dialog showDialogNoCancelable(Context ctx, int titleId, int msgId,
        DialogInterface.OnClickListener listener)
    {
        if (ctx == null)
        {
