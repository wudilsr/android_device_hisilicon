...
public class SSDP
{
    ...
    public final static void setNetInterfaceUtil(AndoridNetInfoInterface netInfo)
    {
        netInterfaceUtil = netInfo;
    }

    public final static String getBroadCastAddress()
    {
        String brocastAddr = ADDRESS;
        if (netInterfaceUtil != null)
        {
            brocastAddr = netInterfaceUtil.getBroadCastAddress();
            if (brocastAddr == null)
            {
                brocastAddr = ADDRESS;
            }
