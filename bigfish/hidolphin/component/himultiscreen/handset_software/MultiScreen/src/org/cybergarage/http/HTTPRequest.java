...
public class HTTPRequest extends HTTPPacket
{
    ...
    private int mTimeoutConnect = HTTPServer.DEFAULT_CONNECT_TIMEOUT;

    private int mTimeoutRead = HTTPServer.DEFAULT_TIMEOUT;
    ...
    {
        mTimeoutConnect = timeout;
    }

    public void setTimeoutRead(int timeout)
    {
        mTimeoutRead = timeout;
    }
    ...
    public HTTPResponse post(String host, int port, boolean isKeepAlive)
    {
        ...
        try
        {
            if (postSocket == null)
            {
                ...
                postSocket.connect(new InetSocketAddress(host, port), mTimeoutConnect);
                postSocket.setSoTimeout(mTimeoutRead);
                // End modify
            }
    ...
    public HTTPResponse post(String host, int port)
    {
        ...
        // FIXME Modify for MultiScreen
        // return post(host, port, true);
        // End modify
    }
