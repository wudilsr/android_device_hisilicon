...
#include "com_hisilicon_android_inputmethod_keyboard_ProximityInfo.h"
#include "jni.h"
...
static jint hilatinime_Keyboard_setProximityInfo(JNIEnv *env, jobject object,
...
static void hilatinime_Keyboard_release(JNIEnv *env, jobject object, jint proximityInfo) {
...
static JNINativeMethod sKeyboardMethods[] = {
    {"setProximityInfoNative", "(IIIII[II[I[I[I[I[I[F[F[F)I",
            (void*)hilatinime_Keyboard_setProximityInfo},
    {"releaseProximityInfoNative", "(I)V", (void*)hilatinime_Keyboard_release}
};

int register_ProximityInfo(JNIEnv *env) {
    const char *const kClassPathName = "com/hisilicon/android/inputmethod/keyboard/ProximityInfo";
