...
import com.hisilicon.android.inputmethod.compat.InputMethodInfoCompatWrapper;
import com.hisilicon.android.inputmethod.compat.InputMethodManagerCompatWrapper;
import com.hisilicon.android.inputmethod.compat.InputMethodSubtypeCompatWrapper;
...
import com.hisilicon.android.inputmethod.keyboard.KeyboardId;
...
public class Utils {
    ...
    public static void loadNativeLibrary() {
        try {
            System.loadLibrary("jni_hilatinime");
        } catch (UnsatisfiedLinkError ule) {
            Log.e(TAG, "Could not load native library jni_hilatinime");
        }
    }
