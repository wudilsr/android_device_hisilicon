...
public class TabMenu extends PopupWindow {
    ...
    public TabMenu(Context context, Drawable griDrawable,
            OnItemClickListener titleClick, OnItemClickListener bodyClick,
        ...
        // Drawable drawable =
        // context.getResources().getDrawable(R.drawable.gri);
    ...
    public void SetBodyAdapter(MenuBodyAdapter bodyAdapter) {
        gvBody.setNumColumns(bodyAdapter.getCount());
