...
import com.hisilicon.android.gallery3d.util.UpdateHelper;
...
public class LocalVideo extends LocalMediaItem {
    ...
    public static class LocalVideoRequest extends ImageCacheRequest {
        ...
        public Bitmap onDecodeOriginal(JobContext jc, int type) {
            ...
            Bitmap pic_biBitmap = BitmapFactory.decodeResource(mApplication
                    .getAndroidContext().getResources(), R.drawable.movie);
            return pic_biBitmap;
        }
    }
