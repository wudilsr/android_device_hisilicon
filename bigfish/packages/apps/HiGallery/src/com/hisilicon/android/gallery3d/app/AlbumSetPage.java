...
import com.hisilicon.android.gallery3d.picasasource.PicasaSource;
import com.hisilicon.android.gallery3d.settings.GallerySettings;
import com.hisilicon.android.gallery3d.ui.ActionModeHandler;
import com.hisilicon.android.gallery3d.ui.AlbumSetView;
...
import com.hisilicon.android.gallery3d.ui.GridDrawer;
import com.hisilicon.android.gallery3d.ui.HighlightDrawer;
import com.hisilicon.android.gallery3d.ui.PositionProvider;
import com.hisilicon.android.gallery3d.ui.PositionRepository;
import com.hisilicon.android.gallery3d.ui.SelectionManager;
import com.hisilicon.android.gallery3d.ui.SlotView;
import com.hisilicon.android.gallery3d.ui.StaticBackground;
import com.hisilicon.android.gallery3d.ui.ActionModeHandler.ActionModeListener;
...
public class AlbumSetPage extends ActivityState implements
    ...
    public void onBackPressed() {
        if (mShowDetails) {
            ...
            mAlbumSetView.savePositions(PositionRepository
        ...
        if (mShowDetails) {
            ...
            if (mGetAlbum && targetSet.isLeafAlbum()) {
                ...
                Intent result = new Intent().putExtra(
                        AlbumPicker.KEY_ALBUM_PATH, targetSet.getPath()
                                .toString());
    ...
    public void onCreate(Bundle data, Bundle restoreState) {
        ...
        if (actionBar != null) {
            mSelectedAction = data.getInt(
                    AlbumSetPage.KEY_SELECTED_CLUSTER_TYPE,
    ...
    private void clearLoadingBit(int loadingBit) {
        ...
        if (mLoadingBits == 0) {
            ...
            if ((mAlbumSetDataAdapter.size() == 0)) {
                Toast.makeText((Context) mActivity, R.string.empty_album,
    ...
    private void initializeData(Bundle data) {
        ...
        mAlbumSetDataAdapter = new AlbumSetDataAdapter(mActivity, mMediaSet,
                DATA_CACHE_SIZE);
    ...
    private void initializeViews() {
        ...
        Config.AlbumSetPage config = Config.AlbumSetPage
    ...
    protected boolean onCreateActionBar(Menu menu) {
        ...
        if (mGetContent) {
            ...
            if (switchCamera != null) {
                switchCamera.setVisible(GalleryUtils
    ...
    public void onSelectionModeChange(int mode) {
        ...
        case SelectionManager.LEAVE_SELECTION_MODE: {
            mActionMode.finish();
            if (mShowClusterMenu) {
                mActivity.getGalleryActionBar().showClusterMenu(
                        mSelectedAction, this);
            }
            mRootPane.invalidate();
            break;
        }
    ...
    private void showDetails() {
        ...
        if (mDetailsHelper == null) {
            mHighlightDrawer = new HighlightDrawer(
            ...
            public void run() {
                ...
                if (resultCode == MediaSet.SYNC_RESULT_ERROR) {
                    Toast.makeText((Context) mActivity,
                            R.string.sync_album_set_error, Toast.LENGTH_LONG)
                            .show();
                }
            }
        });
