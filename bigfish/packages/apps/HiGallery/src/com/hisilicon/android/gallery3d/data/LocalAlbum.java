...
import com.hisilicon.android.gallery3d.list.ImageModel;
...
public class LocalAlbum extends MediaSet {
    ...
    public ArrayList<MediaItem> getMediaItem(int start, int count) {
        ...
        List<ImageModel> imageModeList = mApplication.getMediaFileListService()
                .getList();
        ...
        if (imageModeList != null && imageModeList.size() > 0) {
            for (int i = 0; i < imageModeList.size(); i++) {
                if (i >= start && i <= (count + start)) {
                    ...
                    Path itemPath = dm.findPathByUri(Uri.parse(imageModel
                            .getPath()));
                    MediaItem mediaItem = (MediaItem) dm
    ...
    public void delete() {
        GalleryUtils.assertNotInRenderThread();
        // delete sdcard file
        Cursor cursor = mApplication.getContentResolver().query(mBaseUri,
