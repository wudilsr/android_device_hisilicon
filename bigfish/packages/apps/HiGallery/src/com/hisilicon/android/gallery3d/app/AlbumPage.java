...
import com.hisilicon.android.gallery3d.ui.AlbumView;
...
public class AlbumPage extends ActivityState implements
        ...
        if (mShowDetails) {
            ...
            if (mGetContent) {
                ...
                if (GifUtils.isGifFile((Context) mActivity,
                    ...
                    mAlbumView.savePositions(PositionRepository
                            .getInstance(mActivity));
                    data.putInt(PhotoPage.KEY_INDEX_HINT, slotIndex);
                    data.putString(PhotoPage.KEY_MEDIA_SET_PATH,
                            mMediaSetPath.toString());
                    data.putString(PhotoPage.KEY_MEDIA_ITEM_PATH, item
                            .getPath().toString());
    ...
    private void startTransition(Bundle data) {
        final PositionRepository repository = PositionRepository
                .getInstance(mActivity);
        final int[] center = data == null ? null : data
                .getIntArray(KEY_SET_CENTER);
        ...
        mAlbumView.startTransition(new PositionProvider() {
            ...
            public Position getPosition(long identity, Position target) {
                ...
                if (center != null) {
                    ...
                    mTempPosition.set(center[0], center[1], 0,
    ...
    private void initializeData(Bundle data) {
        ...
        Utils.assertTrue(mMediaSet != null, "MediaSet is null. Path = %s",
                mMediaSetPath);
            ...
            public void run() {
                ...
                if (resultCode == MediaSet.SYNC_RESULT_ERROR) {
                    Toast.makeText((Context) mActivity,
                            R.string.sync_album_error, Toast.LENGTH_LONG)
                            .show();
                }
            }
        });
