...
public class AnimationUpgrade extends Upgrade {
    private final String INTRA_NET_PATH = "no";//set path for download XML file
    private final String FILE_NAME = "bootanimation.zip";
    private final String PREFERENCES_NAME = "bootanimation";

    public AnimationUpgrade(Context context, DownloadManager mDownloadManager) {
    ...
    public List<UpgradeEntity> parse(InputStream is) throws Exception {
        ...
        while (eventType != XmlPullParser.END_DOCUMENT) {
            ...
            case XmlPullParser.START_TAG:
                if (parser.getName().equals("BootAnimationUpgrade")) {
