...
public class FastplayUpgrade extends Upgrade {
    private final String INTRA_NET_PATH = "no";//set path for download XML file
    private final String FILE_NAME = "fastplay.img";
    private final String PREFERENCES_NAME = "fastplay";

    public FastplayUpgrade(Context context, DownloadManager mDownloadManager) {
    ...
    public List<UpgradeEntity> parse(InputStream is) throws Exception {
        ...
        while (eventType != XmlPullParser.END_DOCUMENT) {
            ...
            case XmlPullParser.START_TAG:
                if (parser.getName().equals("FastplayUpgrade")) {
