 ...
 * <p><img src="../../../../../img/MediaplayerCallPath.gif"
 *         alt="Hisi Mediaplayer Interfaces Description"
 *         border="0" /></p>
 * <p>
 *
 * <p>Look the diagram above,app can call android interface--MediaPlayer to construct player,
 * or can call hisi-extend interface--HiMediaPlayer to construct player.In the two path both,you can
 * use HiMediaPlayerInvoke to get many hisi-extend useful function.We mainly describe HiMediaPlayer
