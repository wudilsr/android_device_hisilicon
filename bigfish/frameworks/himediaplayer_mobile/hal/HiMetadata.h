...
#ifndef ANDROID_MEDIA_HIMETADATA_H
#define ANDROID_MEDIA_HIMETADATA_H
...
public:
            ...
            bool AppendStringMeta(int key, String16 & str);
            bool AppendByteMeta(int key, char *val, int size);
private:
            HiMetadata(const HiMetadata&);
            HiMetadata& operator=(const HiMetadata&);
