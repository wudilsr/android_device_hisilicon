...
#define LOG_NDEBUG 0
#define LOG_TAG "HiMetadataRetriever"
#include <utils/Log.h>
...
namespace android {
    ...
    void HiPlayerMetadata::convertMetadata()
    {
        ...
        static const KeyMap kMap[] = {
            ...
            { HiKeyCDTrackNumber, METADATA_KEY_CD_TRACK_NUMBER },
            ...
            { HiKeyLanguage,   METADATA_KEY_TIMED_TEXT_LANGUAGES},
