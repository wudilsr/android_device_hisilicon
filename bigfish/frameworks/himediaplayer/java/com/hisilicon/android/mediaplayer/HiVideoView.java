...
public class HiVideoView extends SurfaceView implements MediaPlayerControl {
    ...
    HiMediaPlayer.OnPreparedListener mPreparedListener = new HiMediaPlayer.OnPreparedListener() {
        public void onPrepared(HiMediaPlayer mp) {
            ...
            Metadata data = mp.getMetadata(HiMediaPlayer.METADATA_ALL,
                                      HiMediaPlayer.BYPASS_METADATA_FILTER);
    ...
    private HiMediaPlayer.OnErrorListener mErrorListener =
        ...
        public boolean onError(HiMediaPlayer mp, int framework_err, int impl_err) {
            ...
            /*if (getWindowToken() != null) {
                ...
                if (framework_err == HiMediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
    ...
    SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback()
    {
        public void surfaceChanged(SurfaceHolder holder, int format,
                                    int w, int h)
        {
            int left = holder.getSurface().getVideoRect().left;
            int right = holder.getSurface().getVideoRect().right;
            int top = holder.getSurface().getVideoRect().top;
            int bottom = holder.getSurface().getVideoRect().bottom;
            mSurfaceWidth = w;
            mSurfaceHeight = h;
