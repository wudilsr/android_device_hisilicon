...
public abstract class TrackRenderer implements ExoPlayerComponent {
  ...
  /**
   * The value referrence DemoPlayer.java
   */
  public static final int TYPE_VIDEO = 0;
  public static final int TYPE_AUDIO = 1;
  public static final int TYPE_OTHER = 2;

  private int mRenderType = TYPE_OTHER;

  private boolean mInitialized = false;
  private boolean mTunneled = false;
  private boolean mSoftwareCodec = false;
  private int mAudioSessionId = AudioTrack.SESSION_ID_NOT_SET;
   ...
   * @throws ExoPlaybackException If an error occurs.
   */
  protected abstract void doSomeWork(long positionUs, long elapsedRealtimeUs, Message msg)
      throws ExoPlaybackException;
  ...
  protected final void setInitialized(boolean inited) {
      mInitialized = inited;
  }

  protected final boolean isTunneled() {
      return mTunneled;
  }
  ...
  protected final boolean getSoftwareCodec() {
      return mSoftwareCodec;
  }

  public void setSoftwareCodec(boolean software) {
