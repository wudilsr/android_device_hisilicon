...
public final class FragmentedMp4Extractor implements Extractor {
  ...
  public FragmentedMp4Extractor(int flags, Track sideloadedTrack) {
    ...
    trackBundles = new SparseArray<TrackBundle>();
  ...
  private void onMoovContainerAtomRead(ContainerAtom moov) {
    ...
    SparseArray<DefaultSampleValues> defaultSampleValuesArray = new SparseArray<DefaultSampleValues>();
    ...
    SparseArray<Track> tracks = new SparseArray<Track>();
