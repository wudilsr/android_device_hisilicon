...
public final class WebvttCueParser {
  ...
  private static int parsePositionAnchor(String s) {
    ...
    } else if (s.equals("center") || s.equals("middle")) {
  ...
  private static Alignment parseTextAlignment(String s) {
    if (s.equals("start") || s.equals("left")){
  ...
  private static void applyEntity(String entity, SpannableStringBuilder spannedText) {
    if (entity.equals(ENTITY_LESS_THAN)) {
        ...
        spannedText.append('>');
    } else if (entity.equals(ENTITY_NON_BREAK_SPACE)) {
        spannedText.append(' ');
  ...
  private static boolean isSupportedTag(String tagName) {
    if (tagName.equals(TAG_BOLD) || tagName.equals(TAG_CLASS) || tagName.equals(TAG_ITALIC)
        || tagName.equals(TAG_LANG) || tagName.equals(TAG_UNDERLINE) || tagName.equals(TAG_VOICE)) {
        return true;
    } else {
        return false;
    }
