...
public class StreamingDrmSessionManager implements DrmSessionManager {
   ...
   * Empty DRM UUID
   */
  public static final UUID EMPTY_DRM_UUID = new UUID(0x9A04F07998404286L, 0xAB92E65BE0111111L);
  ...
  /**
   * Instantiates a new instance using the Empty DRM scheme, for hisilicon TVP secure memory path.
   ...
   */
  public static StreamingDrmSessionManager newEmptyDrmInstance(Looper playbackLooper,
          MediaDrmCallback callback, HashMap<String, String> optionalKeyRequestParameters,
          Handler eventHandler, EventListener eventListener) throws UnsupportedDrmException {
        return new StreamingDrmSessionManager(EMPTY_DRM_UUID, playbackLooper, callback,
            optionalKeyRequestParameters, eventHandler, eventListener);
  }
