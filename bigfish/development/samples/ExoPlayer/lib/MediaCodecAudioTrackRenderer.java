...
public class MediaCodecAudioTrackRenderer extends MediaCodecTrackRenderer implements MediaClock {
  ...
  protected boolean processOutputBuffer(long positionUs, long elapsedRealtimeUs, MediaCodec codec,
    ...
    if (!audioTrack.isInitialized()) {
      ...
      try {
        if (isTunneled()) {
            audioTrack.initialize(audioSessionId, true);
        } else if (audioSessionId != AudioTrack.SESSION_ID_NOT_SET) {
          audioTrack.initialize(audioSessionId, false);
        } else {
      ...
      if (isTunneled() || getState() == TrackRenderer.STATE_STARTED) {
        audioTrack.play();
      }
    } else {
