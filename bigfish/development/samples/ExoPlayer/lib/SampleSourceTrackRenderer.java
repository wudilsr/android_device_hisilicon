...
public abstract class SampleSourceTrackRenderer extends TrackRenderer {
  ...
  @Override
  protected final void doSomeWork(long positionUs, long elapsedRealtimeUs, Message msg)
      throws ExoPlaybackException {
    positionUs = shiftInputPosition(positionUs);
    ...
    doSomeWork(positionUs, elapsedRealtimeUs, sourceIsReady, msg);
  }
   ...
   * @throws ExoPlaybackException
   */
  protected abstract void doSomeWork(long positionUs, long elapsedRealtimeUs, boolean sourceIsReady, Message msg)
      throws ExoPlaybackException;
