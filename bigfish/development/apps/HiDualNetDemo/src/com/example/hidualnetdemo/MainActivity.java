package com.example.hidualnetdemo;
...
import com.example.hidualnetdemo.R;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private final static int IS_LINK_UP = 1;
    private final static int IS_LINK_DOWN = 2;
    ...
    private Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            if(IS_LINK_UP == what){
                ...
                setButtonEnable();
            }else if(IS_LINK_DOWN == what){
                mHiNetworkUtils.disableInterface(INTERFACE);
                setButtonEnable();
                Toast.makeText(MainActivity.this, "Please connect the network cable !", Toast.LENGTH_SHORT).show();
            }else textView1.setText(resolvedIpaddress);
        };
    };
    ...
    private void init() {
        ...
        mHiNetworkUtils = new HiNetworkUtils(MainActivity.this);
        receiver = new MyBroadcastReceiver();
    }

    private void setButtonEnable() {
        if (HiNetworkUtils.INTERFACE_STATUS_LINK_UP == mHiNetworkUtils
    ...
    private Dialog buildDialog(final int id) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                nm = NetworkUtils.inetAddressToInt((Inet4Address)iNetmask);
    ...
    private Dialog buildDialog3() {
        ...
        final View textEntryView = inflater.inflate(R.layout.alert_dialog_3,
                null);
        editTExt1 = (EditText) textEntryView.findViewById(R.id.edit_text_1);
