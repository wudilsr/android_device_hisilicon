...
HI_S32 VDEC_VPU_PutFrame(HI_HANDLE hVdec,HI_DRV_VDEC_USR_FRAME_S *pstBuf);
...
HI_S32 VDEC_VPU_PtsAlloc(HI_HANDLE hInst, HI_HANDLE vpuHandle); // modified by w00278582 
HI_S32 VDEC_VPU_PtsFree(HI_HANDLE hInst, HI_HANDLE vpuHandle);  // modified by w00278582
...
HI_S32 VPU_SetFrmRate(HI_HANDLE hVdec, const HI_UNF_AVPLAY_FRMRATE_PARAM_S *pstFrmRate);
HI_S32 VPU_GetFrmRate(HI_HANDLE hVdec, HI_UNF_AVPLAY_FRMRATE_PARAM_S *pstFrmRate);

// add by w00278582
HI_S32 VDEC_VPU_ProcStatus(HI_HANDLE hHandle, HI_DRV_VDEC_VPU_STATUS_S *stVPUStatus);
