...
HI_S32 VDEC_OpenDevFile(HI_VOID)
{
    ...
    if (0 == s_stVdecAdpParam.u32InitCount)
    {
        if (-1 == s_stVdecAdpParam.s32DevFd)
        {
            ...
            if (HI_SUCCESS != VDEC_VPU_Init())
            {
                HI_ERR_VDEC("vdec vpu init failed\n");
            }
           #endif
        }
    }
...
#if (HI_VDEC_VPU_SUPPORT == 1)
HI_S32 VDEC_VPU_CreateFrameBuf(HI_MMZ_BUF_S *pStreamBuf)
{
    HI_S32 s32Ret;
    ...
    {
        HI_ERR_VDEC("Invalid para in function VDEC_VPU_CreateFrameBuf!\n");
        return HI_ERR_VDEC_INVALID_PARA;
    }
...
#ifdef VPU_MEM_MAP    
	pStreamBuf->user_viraddr = (HI_U8 *)HI_MEM_Map(pStreamBuf->phyaddr,pStreamBuf->bufsize);
#else
    pStreamBuf->user_viraddr = HI_NULL;
#endif
    return HI_SUCCESS;
}

HI_S32 VDEC_VPU_RevertFrameBuf(HI_U32 u32Phyaddr)
{
    HI_S32 s32Ret;
    /* Ioctl UMAPC_VDEC_CHAN_GETFRM */
...
HI_S32 VDEC_VPU_CreateFrameList(HI_HANDLE hVdec)
{
    HI_S32 s32Ret;
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("VDEC_CreateVpuFrameList %d err:%x!\n", stParam.hHandle, s32Ret);
        return HI_FAILURE;
    }

    HI_INFO_VDEC("VDEC_CreateVpuFrameList %d OK\n", stParam.hHandle);
    return HI_SUCCESS;
	
}

HI_S32 VDEC_VPU_ReleaseFrameList(HI_HANDLE hVdec)
{
    HI_S32 s32Ret;
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("VDEC_VPU_ReleaseFrameList %d err:%x!\n", stParam.hHandle, s32Ret);
        return HI_FAILURE;
    }

    HI_INFO_VDEC("VDEC_VPU_ReleaseFrameList %d OK\n", stParam.hHandle);
    return HI_SUCCESS;
	
}

HI_S32 VDEC_VPU_PutFrame(HI_HANDLE hVdec,HI_DRV_VDEC_USR_FRAME_S *pstFrame)
{
    HI_S32 s32Ret;
    VDEC_CMD_VPU_PUT_FRAME_S stParam;
	
	stParam.hHandle = hVdec;
	memcpy(&(stParam.stFrame),pstFrame,sizeof(HI_DRV_VDEC_USR_FRAME_S));
    s32Ret = ioctl(s_stVdecAdpParam.s32DevFd, UMAPC_VDEC_CHAN_VPU_PUT_FRAME, &stParam);
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("VDEC_VPU_PutFrame %d err:%x!\n", stParam.hHandle, s32Ret);
        return HI_FAILURE;
    }

    HI_INFO_VDEC("VDEC_VPU_PutFrame %d OK\n", stParam.hHandle);
    return HI_SUCCESS;
}

HI_S32 VDEC_VPU_SetAttr(HI_HANDLE hVdec,VDEC_VPU_ATTR_S *pstVPUAttr)
{
    HI_S32 s32Ret;
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("VDEC_VPU_SetAttr %d err:%x!\n", stParam.hHandle, s32Ret);
        return HI_FAILURE;
    }
    HI_INFO_VDEC("VDEC_VPU_SetAttr %d OK\n", stParam.hHandle);
    return HI_SUCCESS;  
}

HI_S32 VDEC_VPU_CheckRlsFrameID(HI_HANDLE hVdec, HI_S32 *pID, HI_S32 *ps32Count)
{
    HI_S32 s32Ret;
	...
	if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("VDEC_VPU_CheckRlsFrameID %d err:%x!\n", stParam.hHandle, s32Ret);
        return HI_FAILURE;
    }

	*ps32Count = stParam.s32Count;
	memcpy(pID,stParam.as32FrameID,sizeof(HI_S32)*HI_VDEC_MAX_VPU_FRAME_NUM);
    HI_INFO_VDEC("VDEC_VPU_CheckRlsFrameID %d OK\n", stParam.hHandle);
    return HI_SUCCESS;
}

HI_S32 VDEC_VPU_Start(HI_HANDLE hInst)
{
    HI_S32 s32Ret;
    HI_HANDLE hHandle = VFMW_INST_HANDLE(hInst);
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VPU start err:%x!\n", hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    HI_INFO_VDEC("Chan %d VPU start.\n", hHandle);
    return HI_SUCCESS;
}


HI_S32 VDEC_VPU_Stop(HI_HANDLE hInst)
{
    HI_S32 s32Ret;
    HI_HANDLE hHandle = VFMW_INST_HANDLE(hInst);
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VPU stop err:%x!\n", hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    HI_INFO_VDEC("Chan %d VPU stop.\n", hHandle);
    return HI_SUCCESS;
}


HI_S32 VDEC_VPU_PtsAlloc(HI_HANDLE hInst, HI_HANDLE vpuHandle)
{
    HI_S32 s32Ret;
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VDEC_VPU_PTS_Alloc err:%x!\n", hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    HI_INFO_VDEC("Chan %d VDEC_VPU_PTS_Alloc.\n", hHandle);
    return HI_SUCCESS;
}

HI_S32 VDEC_VPU_PtsFree(HI_HANDLE hInst, HI_HANDLE vpuHandle)
{
    HI_S32 s32Ret;
    VDEC_CMD_VPU_PROC_HANDLE_S stVdecVPUHandle;
    HI_HANDLE hHandle = VFMW_INST_HANDLE(hInst);
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VDEC_VPU_PtsFree err:%x!\n", hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    HI_INFO_VDEC("Chan %d VDEC_VPU_PtsFree.\n", hHandle);
    return HI_SUCCESS;
}

HI_S32 VDEC_VPU_PtsStart(HI_HANDLE hInst)
{
    HI_S32 s32Ret;
    HI_HANDLE hHandle = VFMW_INST_HANDLE(hInst);
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VDEC_VPU_PTS_Start err:%x!\n", hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    HI_INFO_VDEC("Chan %d VDEC_VPU_PTS_Start.\n", hHandle);
    return HI_SUCCESS;
}

HI_S32 VDEC_VPU_PtsStop(HI_HANDLE hInst)
{
    HI_S32 s32Ret;
    HI_HANDLE hHandle = VFMW_INST_HANDLE(hInst);
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VDEC_VPU_PTS_Stop err:%x!\n", hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    HI_INFO_VDEC("Chan %d VDEC_VPU_PTS_Stop.\n", hHandle);
    return HI_SUCCESS;
}

HI_S32 VDEC_VPU_PtsReset(HI_HANDLE hInst)
{
    HI_S32 s32Ret;
    HI_HANDLE hHandle = VFMW_INST_HANDLE(hInst);
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VDEC_VPU_PTS_Reset err:%x!\n", hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    HI_INFO_VDEC("Chan %d VDEC_VPU_PTS_Reset.\n", hHandle);
    return HI_SUCCESS;
}


HI_S32 VDEC_VPU_GetFrameRateForNewFrm(HI_HANDLE hHandle, HI_U32 *u32FrameRate)
{
    HI_S32 s32Ret;
	VDEC_CMD_VO_FRAME_S stParam;
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VDEC_VPU_GetFrameRate err:%x!\n", hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

	*u32FrameRate = stParam.stFrame.u32FrameRate ;
	
    HI_INFO_VDEC("Chan %d VDEC_VPU_GetFrameRate.\n", hHandle);
    return HI_SUCCESS;
}



HI_S32 VPU_GetVpssStatusInfo(HI_HANDLE hVdec, HI_BOOL *bAllPortCompleteFrm)
{
    HI_S32 s32Ret;
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VPU_GetVpssStatusInfo err:%x!\n", stParam.hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }
	
	*bAllPortCompleteFrm = stParam.bAllPortCompleteFrm;
	
    HI_INFO_VDEC("Chan %d VPU_GetVpssStatusInfo OK\n", stParam.hHandle);
    return HI_SUCCESS;
}


HI_S32 VPU_SetFrmRate(HI_HANDLE hInst, const HI_UNF_AVPLAY_FRMRATE_PARAM_S *pstFrmRate)
{
    HI_S32 s32Ret;
    VDEC_CMD_FRAME_RATE_S stParam;
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VPU SetFrmRate err:%x!\n", stParam.hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    HI_INFO_VDEC("Chan %d VPU SetFrmRate OK\n", stParam.hHandle);
    return HI_SUCCESS;
}

HI_S32 VPU_GetFrmRate(HI_HANDLE hInst, HI_UNF_AVPLAY_FRMRATE_PARAM_S *pstFrmRate)
{
    HI_S32 s32Ret;
    VDEC_CMD_FRAME_RATE_S stParam;
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VPU GetFrmRate err:%x!\n", stParam.hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    *pstFrmRate = stParam.stFrameRate;
    HI_INFO_VDEC("Chan %d VPU GetFrmRate OK\n", stParam.hHandle);
    return HI_SUCCESS;
}

HI_S32 VDEC_VPU_ProcStatus(HI_HANDLE hHandle, HI_DRV_VDEC_VPU_STATUS_S *pstVPUStatus)
{
    HI_S32 s32Ret;

    VDEC_CMD_VPU_PROC_STATUS_S stVpuProcStatus;

    if (HI_NULL == pstVPUStatus)
    {
        HI_ERR_VDEC("Bad param.\n");
        return HI_ERR_CODEC_INVALIDPARAM;
    }
    ...
    memcpy(&(stVpuProcStatus.stVPUStatus), pstVPUStatus, sizeof(HI_DRV_VDEC_VPU_STATUS_S));

    /* Ioctl UMAPC_VDEC_CHAN_START */
    s32Ret = ioctl(s_stVdecAdpParam.s32DevFd, UMAPC_VDEC_VPU_PROC, &stVpuProcStatus);
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_VDEC("Chan %d VPU err:%x!\n", hHandle, s32Ret);
        return HI_ERR_CODEC_OPERATEFAIL;
    }

    HI_INFO_VDEC("Chan %d VPU.\n", hHandle);
    return HI_SUCCESS;
}
#endif
