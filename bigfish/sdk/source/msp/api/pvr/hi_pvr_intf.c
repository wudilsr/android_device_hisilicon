...
static PVR_EVENT_CALLBACK_TYPE_E g_callBackType;
...
STATIC HI_VOID* PVRIntfEventRoutine(HI_VOID *args)
{
    ...
    {
        eventDone = 0;
        if (g_callBackType == PVR_EVENT_CALLBACK_BY_TYPE || g_callBackType == PVR_EVENT_CALLBACK_BOTH)
        {
        ...
        else if (g_callBackType == PVR_EVENT_CALLBACK_BY_CHN || g_callBackType == PVR_EVENT_CALLBACK_BOTH)
        {
