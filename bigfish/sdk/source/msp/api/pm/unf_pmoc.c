...
static HI_BOOL g_bMouseKeyboardEnable;
...
HI_S32 HI_UNF_PMOC_SetWakeUpAttr(HI_UNF_PMOC_WKUP_S_PTR pstAttr)
{
    ...
    g_bMouseKeyboardEnable = pstAttr->bMouseKeyboardEnable;
...
HI_S32 HI_UNF_PMOC_GetWakeUpAttr(HI_UNF_PMOC_WKUP_S_PTR pstAttr)
{
    ...
    pstAttr->bMouseKeyboardEnable = g_bMouseKeyboardEnable;

    if (1 == pmocVal.resumeResetFlag)
    {
        pstAttr->bResumeResetEnable = HI_TRUE;
    }
