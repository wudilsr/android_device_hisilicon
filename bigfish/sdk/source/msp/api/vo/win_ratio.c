...
{  
	...
	if ( pstDrvPara->stOutWnd.s32Width==0 || pstDrvPara->stOutWnd.s32Width > 4096 
		|| pstDrvPara->stOutWnd.s32Height==0 || pstDrvPara->stOutWnd.s32Height > 4096 
		|| pstDrvPara->stInWnd.s32Height == 0 || pstDrvPara->stInWnd.s32Height > 4096 
		|| pstDrvPara->stInWnd.s32Width == 0 || pstDrvPara->stInWnd.s32Width > 4096 
		|| pstDrvPara->SrcImgW == 0 || pstDrvPara->SrcImgW > 4096 
		|| pstDrvPara->SrcImgH == 0 || pstDrvPara->SrcImgH > 4096  
		|| pstDrvPara->stScreen.s32Width > 4096 || pstDrvPara->stScreen.s32Height > 4096)
	{
