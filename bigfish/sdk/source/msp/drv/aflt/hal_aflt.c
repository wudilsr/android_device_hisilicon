...
static HI_VOID AFLTIOAddressMap(HI_U32 u32AfltRegBase)
{
    ...
    g_u32RegMapAddr = (HI_U32)ioremap_nocache(u32AfltRegBase, AFLT_REG_LENGTH);

    /* reg map */
    g_pAfltComReg = (S_AFLT_COM_ATTR *)(g_u32RegMapAddr + AFLT_COM_REG_OFFSET);
    for (u32AfltId = 0; u32AfltId < AFLT_MAX_CHAN_NUM; u32AfltId++)
    {
        g_pAfltChnReg[u32AfltId] = (S_AFLT_REGS_TYPE *)((g_u32RegMapAddr + AFLT_CHN_REG_OFFSET) + AFLT_CHN_REG_BANDSIZE * u32AfltId);
    }
...
HI_VOID AFLT_HAL_Init(HI_U32 u32AfltRegBase)
{
...
HI_VOID AFLT_HAL_SetMsgPoolAttr(HI_U32 u32AfltId, HAL_AFLT_MSGPOOL_ATTR_S *pstAttr)
{
    ...
    AfltReg->MSGPOOL_ADDR = pstAttr->u32MsgPoolAddr;
...
HI_S32 AFLT_HAL_InitInbuf(HI_U32 u32AfltId, HAL_AFLT_INBUF_ATTR_S* pstAttr)
{
    ...
    AfltReg->IP_BUF_ADDR = pstAttr->u32BufAddr;
...
HI_S32 AFLT_HAL_InitOutbuf(HI_U32 u32AfltId, HAL_AFLT_OUTBUF_ATTR_S* pstAttr)
{
    ...
    AfltReg->OP_BUF_ADDR = pstAttr->u32BufAddr;
