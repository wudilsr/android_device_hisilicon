...
HI_S32 wmeminit(void)
{
    ...
    g_u32MemPoolPhyAddr = HI_GFX_AllocMem("TDE_MemPool",g_pszTdeMmzName,TDE_MEMPOOL_SIZE);
    ...
    #else
    g_u32MemPoolVrtAddr = (HI_U32 )HI_GFX_Map(g_u32MemPoolPhyAddr,TDE_MEMPOOL_SIZE);
    #endif
