...
HI_S32 DispSearchCastHandle(HI_HANDLE* cast_ptr, HI_DRV_DISPLAY_E enDisp)
{
    DISP_S* pstDisp;
...
HI_S32 DispGetCastHandle(HI_DRV_DISPLAY_E enDisp, HI_HANDLE *phCast, HI_HANDLE *phCast_ptr)
{
    DISP_S *pstDisp = HI_NULL;
    DispGetPointerByID(enDisp, pstDisp);
...
{
    (HI_VOID)DISP_SetCGMS_A(enDisp, pstCgmsCfg);
