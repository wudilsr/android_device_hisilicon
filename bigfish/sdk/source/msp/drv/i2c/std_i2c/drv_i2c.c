...
static HI_U32   g_astI2cIRQ[HI_MAX_I2C_NUM] = {I2C0_IRQ, I2C1_IRQ, I2C2_IRQ, I2C3_IRQ, I2C4_IRQ,I2C5_IRQ,I2CADC_IRQ,I2CQAM_IRQ};
#endif
...
HI_S32 HI_DRV_I2C_Init(HI_VOID)
{
    ...
    {
        HI_INFO_I2C(" I2C Module register failed 0x%x.\n", s32Ret);
        return HI_FAILURE;
    }
    ...
    g_I2cKernelAddr[5] = IO_ADDRESS(I2C_QAMADC_PHY_ADDR);
    g_I2cKernelAddr[6] = IO_ADDRESS(I2C_QAMT_PHY_ADDR);
    g_I2cKernelAddr[7] = IO_ADDRESS(I2C7_PHY_ADDR);
#elif  defined(CHIP_TYPE_hi3798cv200_a)
    g_I2cKernelAddr[3] = IO_ADDRESS(I2C3_PHY_ADDR);
    g_I2cKernelAddr[4] = IO_ADDRESS(I2C4_PHY_ADDR);
    g_I2cKernelAddr[5] = IO_ADDRESS(I2C5_PHY_ADDR);
    g_I2cKernelAddr[6] = IO_ADDRESS(ADCI2C_PHY_ADDR);
    g_I2cKernelAddr[7] = IO_ADDRESS(QAMI2C_PHY_ADDR);
#endif
