...
#define DMAC_INT    (30 + 32)

 #define DMAC_CRG_BASE				 0xF8A220A4
 #define DMAC_CRG_REG			 	IO_ADDRESS(DMAC_CRG_BASE)
 #define DMAC_BASE_REG                           0xF9870000
...
#define DDRAM_ADRS              0x00000000                /* 3720 change */
#define DDRAM_SIZE              0xEFFFFFFF        /* 3720 change */
