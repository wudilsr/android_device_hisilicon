...
******************************************************************************/
#ifndef __PQ_MNG_SCALER_H__
#define __PQ_MNG_SCALER_H__
...
#define ZME_COEF_SIZE           18
#define ZME_RATIO_HOR_SHIFT     20
#define ZME_RATIO_VER_SHIFT     12
#define ZME_MULTIPLIER          100

typedef enum hiZME_COEF_RATIO_E
{
    ZME_COEF_RATIO_IN = 0,
    ZME_COEF_RATIO_EQ,
    ZME_COEF_RATIO_OUT_075,
    ZME_COEF_RATIO_OUT_050,
    ZME_COEF_RATIO_OUT_033,
    ZME_COEF_RATIO_OUT_025,
    ZME_COEF_RATIO_OUT_0,
    
    ZME_COEF_RATIO_BUTT
} ZME_COEF_RATIO_E;

typedef enum hiZME_TAP_E
{
    ZME_TAP_8LH = 0,
    ZME_TAP_6LV,
    ZME_TAP_8CH,
...
typedef enum hiVDP_COEF_TYPE_E
{
    VDP_COEF_HOR_LUMA = 0,
    VDP_COEF_HOR_CHROMA,
    VDP_COEF_VER_LUMA,
...
/* YUV信号系数 */
static const HI_S32 coef_lanczos3[ZME_COEF_SIZE][8] = {
...
static const HI_S32 coef6_6M_a25[ZME_COEF_SIZE][6] = {
    {-34,  78,  415,  78,   -34,  9},
    {-32,  66,  415,  90,   -36,  9},
    {-29,  54,  413,  103,  -38,  9},
    {-26,  43,  411,  116,  -41,  9},
...
static const HI_S32 coef4_5M_a15[ZME_COEF_SIZE][4] = {
    {103,  335,  103,  -29},
    {92,   335,  112,  -27},
    {84,   335,  121,  -28},
    {75,   334,  131,  -28},
...
static const HI_S32 coef8_cubic[ZME_COEF_SIZE][8] = {
    {0,   0,   0,    511,  0,    0,    0,   0},
    {-1,  3,   -12,  511,  14,   -4,   1,   0},
    {-2,  6,   -23,  509,  28,   -8,   2,   0},
...
static const HI_S32 coef6_cubic[ZME_COEF_SIZE][6] = {
    {0,    0,   511,  0,     0,   0},
    {3,   -12,  511,  13,   -3,   0},
    {6,   -22,  507,  28,   -7,   0},
    {8,   -32,  502,  44,   -11,  1},
...
static const HI_S32 coef4_cubic[ZME_COEF_SIZE][4] = {
    {0,    511,  0,     0},
    {-19,  511,  21,   -1},
    {-37,  509,  42,   -2},
    {-51,  504,  64,   -5},
...
static const HI_S32 coef8_lanczos2_8tap[ZME_COEF_SIZE][8] = {
...
static const HI_S32 coef6_5M_a25[ZME_COEF_SIZE][6] = {
    {-31,   104,  362,  104,  -31,   4},
    {-30,   94,   362,  114,  -32,   4},
    {-29,   84,   361,  125,  -32,   3},
    {-28,   75,   359,  136,  -33,   3},
...
static const HI_S32 coef6_4M_a20[ZME_COEF_SIZE][6] = {
    {-20,  130,  297,  130,  -20,  -5},
    {-21,  122,  298,  138,  -19,  -6},
    {-22,  115,  297,  146,  -17,  -7},
    {-22,  108,  296,  153,  -16,  -7},
...
static const HI_S32 coef8_3M_a19[ZME_COEF_SIZE][8] = {
...
static const HI_S32 coef6_3M_a15[ZME_COEF_SIZE][6] = {
    {16,  136,  217,  136,  16,  -9},
    {13,  132,  217,  141,  18,  -9},
...
static const HI_S32 coef4_4M_a15[ZME_COEF_SIZE][4] = {
    {120,  281,  120,  -9},
    {113,  281,  127,  -9},
    {106,  280,  134,  -8},
    {99,   279,  141,  -7},
...
//1.944M
static const HI_S32 coef8_2M_a05[ZME_COEF_SIZE][8] = {                            
...
//1.33M
static const HI_S32 coef8_1_5M_a05[ZME_COEF_SIZE][8] = 
{
...
//1.782M
static const HI_S32 coef6_2M_a05[ZME_COEF_SIZE][6] = 
{
...
static const HI_S32 coef6_1_5M_a05[ZME_COEF_SIZE][6] = 
{
...
static const HI_S32 coef6_lag_3[ZME_COEF_SIZE][6] = 
{
    {  0, 0, 512, 0,   0, 0},     //0相位
    {  8, 0, 512, 0,  -8, 0},    //1/32相位
    { 17, 0, 510, 0, -15, 0},
    { 26, 0, 508, 0, -22, 0},
    { 36, 0, 504, 0, -28, 0},
    { 46, 0, 500, 0, -34, 0},
    ...
    {161, 0, 414, 0, -63, 0},
    {176, 0, 400, 0, -64, 0},
    {  0, 0, 256, 0, 256, 0},   //16/32相位
    { 0,  0,   0, 0,   0, 0},//512

};

//2.376M
static const HI_S32 coef4_2M_a05[18][4] =
{
  	{148, 171, 148, 45},//512
  	{145, 170, 149, 48},//512
  	{142, 170, 149, 51},//511
...
//2.317M
static const HI_S32 coef4_1_5M_a05[18][4] =
{
	{150, 158, 150, 54},//513
	{147, 157, 150, 58},//513
	{145, 156, 150, 61},//512
...
//3D LBL缩放系数
static const HI_S32 coef6_cubic_3d[ZME_COEF_SIZE][6] = 
{
    {  0,   0,  511,  511,   0,   0}, //0相位
...
/**
 \brief 获取VDP scaler参数
 \attention \n
  无

 \param[in] pstScalerInfo;
 \           pvCoefLAddr；
             pvCoefCAddr
 \retval ::HI_SUCCESS
 */
HI_S32 PQ_MNG_GetVdpScalerCoef(HI_PQ_SCALER_S *pstScalerInfo, HI_VOID *pvCoefLAddr,HI_VOID *pvCoefCAddr);

/**
 \brief 获取VPSS scaler参数
 \attention \n
  无
 ...
 \retval ::HI_SUCCESS
 */
HI_S32 PQ_MNG_GetVpssScalerCoef(HI_PQ_SCALER_S *pstScalerInfo, HI_VOID *pvCoefLAddr,HI_VOID *pvCoefCAddr);
/*
 * @pvCoefAddr : 填充WBC缩放系数的内存虚拟地址
 * @bHorizontal: 更新类型, TRUE-水平缩放系数更新; FALSE-垂直缩放系数更新
 * @u32YRatio  : 亮度的缩放倍率
 * @u32CRatio  : 色度的缩放倍率
 */
HI_S32 PQ_MNG_GetWbcScalerCoef(HI_PQ_SCALER_S *pstScalerInfo, HI_VOID* pvCoefAddrY, HI_VOID* pvCoefAddrC);
/**
 \brief 获取驱动传递的scaler信息
 \attention \n
  无
 ...
 */
HI_S32 PQ_MNG_ReadScalerInfo(HI_BOOL bVpssType, HI_BOOL bHorizontal, HI_PQ_SCALER_S *pstGetScalerInfo);
