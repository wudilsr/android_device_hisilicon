...
volatile S_VDP_REGS_TYPE* pOptmVdpReg       = NULL;
...
HI_VOID OPTM_VDP_WBC_SetPreZmeEnable(OPTM_VDP_LAYER_WBC_E enLayer, HI_U32 bEnable)
{
    ...
    WBC_GP0_HPZME.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->WBC_GP0_HPZME.u32)));
    WBC_GP0_HPZME.bits.hpzme_en = bEnable;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->WBC_GP0_HPZME.u32)), WBC_GP0_HPZME.u32);
}
