...
REGION1 16M    ------------ 0x1F800000   504M  ------------------------
       	                                           SEC_MMZ 8M
--------------------------- 0x1F000000   496M   ------------------------
               REGION2/REGION4 0M
REGION3 16M   ------------- 0x1F000000   496M   ------------------------
               REGION3 16M                        SEC_OS 32M
--------------------------- 0x1E000000   480M
               REGION5 16M
              ------------- 0x1D000000   464M  -------------------------
                       464M                       NON_SEC_OS 464M
--------------------------- 0x0                 -------------------------
...
/* -------------------------------------------------------- */
/* Secure World */
#define REGION1_BASE (496 * 1024 * 1024)
#define REGION1_SIZE (16 * 1024 * 1024)

#define REGION2_BASE (1024 * 1024 * 1024)
#define REGION2_SIZE (1024 * 1024 * 1024)

#define REGION3_BASE (480 * 1024 * 1024)
#define REGION3_SIZE (16 * 1024 * 1024)

#define REGION4_BASE (2048 * 1024 * 1024UL)
#define REGION4_SIZE (2048 * 1024 * 1024UL)

#define REGION5_BASE (464 * 1024 * 1024)
#define REGION5_SIZE (16 * 1024 * 1024)

#define REGION6_BASE (504 * 1024 * 1024)
#define REGION6_SIZE (8 * 1024 * 1024)

//TODO:XXX
#define REGION7_BASE (512 * 1024 * 1024) //(0)
#define REGION7_SIZE (512 * 1024 * 1024) //(512 * 1024 * 1024)
...
#define SEC_MMZ_SIZE (REGION1_SIZE - REGION6_SIZE)
...
static struct tzascregion tzasc0_regions[MAX_REGIONS] =
{
    ...
    /*      region 2 */
    {.en = 1, .base = REGION2_BASE, .size = REGION2_SIZE, .sp = NONE_RIGHT},
