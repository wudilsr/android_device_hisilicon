...
TA_property_t build_in_service_property[] = {
    ...
    {TEE_SERVICE_WIDEVINE,  DEFAULT_STACK_SIZE*12, DEFAULT_HEAP_SIZE*12, true,     true,   true},
#endif
#ifdef WITH_HISI_PLAYREADY
    {TEE_SERVICE_PLAYREADY, DEFAULT_STACK_SIZE*12, DEFAULT_HEAP_SIZE*18, true,     true,   true},
#endif
#ifdef WITH_HISI_DMX
...
#endif
#ifdef WITH_HISI_VDP
    {TEE_SERVICE_HISI_VDP, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true,     true,   true},
#endif
    {TEE_SERVICE_SSA, DEFAULT_STACK_SIZE*2, DEFAULT_HEAP_SIZE*8, true,     false,   true},
#ifdef WITH_COMPONENT_VMX_ULTRA
    {TEE_SERVICE_STB_VMX_ULTRA_VMXTA, DEFAULT_STACK_SIZE*4, DEFAULT_HEAP_SIZE*4,  true,     true,   true},
    {TEE_SERVICE_STB_VMX_ULTRA_videomarkTA, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true,     true,   true},
#endif
#ifdef WITH_COMPONENT_VMX_ULTRA_VMXTAC_TEST
    {TEE_SERVICE_STB_VMX_ULTRA_VMXTA, DEFAULT_STACK_SIZE*4, DEFAULT_HEAP_SIZE*4,  true,     true,   true},
    {TEE_SERVICE_STB_VMX_ULTRA_videomarkTA, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true,     true,   true},
    {TEE_SERVICE_STB_VMX_ULTRA_VMXTAC_TEST_TA2, DEFAULT_STACK_SIZE*2, DEFAULT_HEAP_SIZE*2, true,     true,   true},
    {TEE_SERVICE_STB_VMX_ULTRA_VMXTAC_TEST_TA3, DEFAULT_STACK_SIZE*2, DEFAULT_HEAP_SIZE*2, true,     true,   true},
#endif
#ifdef WITH_COMPONENT_VMX_ULTRA_ITAC_TEST
    {TEE_SERVICE_STB_VMX_ULTRA_VMXTA, DEFAULT_STACK_SIZE*4, DEFAULT_HEAP_SIZE*4,  true,     true,   true},
    {TEE_SERVICE_STB_VMX_ULTRA_videomarkTA, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true,     true,   true},
    {TEE_SERVICE_STB_VMX_ULTRA_VMXTAC_TEST_TA2, DEFAULT_STACK_SIZE*2, DEFAULT_HEAP_SIZE*2, true,     true,   true},
    {TEE_SERVICE_STB_VMX_ULTRA_VMXTAC_TEST_TA3, DEFAULT_STACK_SIZE*2, DEFAULT_HEAP_SIZE*2, true,     true,   true},
