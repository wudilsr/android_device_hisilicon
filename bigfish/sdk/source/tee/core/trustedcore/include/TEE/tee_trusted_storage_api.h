...
*/
#ifdef GP_V1_1_SUPPORTED
    void TEE_InitRefAttribute(TEE_Attribute* attr,uint32_t attributeID,void* buffer,uint32_t length);
#else
...
*/
#ifdef GP_V1_1_SUPPORTED
    TEE_Result TEE_CreatePersistentObject(uint32_t storageID, void* ojbectID, uint32_t objectIDLen, uint32_t flags, TEE_ObjectHandle attributes, void* initialData, uint32_t initialDataLen, TEE_ObjectHandle* object);
#else
...
*/
#ifdef GP_V1_1_SUPPORTED
    TEE_Result TEE_OpenPersistentObject(uint32_t storageID, void* ojbectID, uint32_t objectIDLen, uint32_t flags, TEE_ObjectHandle* object);
#else
