...
struct ui_text_t
{
    ...
    uint8_t *text;                /* for soft_kbd, it points to short_text. */
...
EXPORTED int32_t ui_measure_text (const char *wtext, int32_t font_size, int32_t spacing, struct text_measure_t * p_measure);
...
EXPORTED char * obj_to_string_s (struct ui_obj_t *obj);
...
EXPORTED void redraw_ui_screen (struct ui_obj_t ** uis, int32_t ui_obj_count, struct rect_t *covering_rect, int32_t if_redraw_def_SI);
EXPORTED void ui_draw_obj (struct ui_obj_t ** uis, int32_t ui_obj_count, struct ui_obj_t *top_obj);
EXPORTED void ui_draw_obj__SI (struct ui_obj_t ** uis, int32_t ui_obj_count, struct ui_obj_t *top_obj, int32_t if_draw_def_SI);
EXPORTED int32_t is_frame_child_by_obj(struct ui_obj_t ** uis, int32_t ui_obj_count, struct ui_obj_t *obj);
EXPORTED int32_t is_frame_child_by_id(struct ui_obj_t ** uis, int32_t ui_obj_count, int32_t child_idx);
...
EXPORTED void app_make_writable_edittext(struct ui_obj_t **app_uis, int32_t app_obj_count);
...
EXPORTED void ui_event_loop_quit(void);
EXPORTED void ui_event_loop (struct ui_obj_t ** uis, int32_t ui_obj_count);  //after invoking start_ui_screen()
