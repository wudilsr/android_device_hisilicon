...
#if defined(WITH_MEDIAOS_BRANCH)
#define TRUSTEDCORE_MAGIC_SIZE 8
#endif

typedef struct{
#if defined(WITH_MEDIAOS_BRANCH)
    UINT8  magic[TRUSTEDCORE_MAGIC_SIZE];  //added by f00208588 for add tag 'TRUSTCORE' at the head of trustcore.img
#endif
...
extern UINT32* global_task_load(TSK_INIT_PARAM_S*);
