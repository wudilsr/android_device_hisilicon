...
#define RESERVED_GROUP_PERMISSION         0x80000000LL

/* Access for all functions - ATTN this is reserved for global task
 * and other test tasks */
#define ALL_GROUP_PERMISSION           (UINT64)-1
/**/
#define GT_PERMISSIONS (CONSOLE_GROUP_PERMISSION | SMC_GROUP_PERMISSION | MM_GROUP_PERMISSION | TASK_GROUP_PERMISSION | KVAR_GROUP_PERMISSION | MEMORY_GROUP_PERMISSION)
