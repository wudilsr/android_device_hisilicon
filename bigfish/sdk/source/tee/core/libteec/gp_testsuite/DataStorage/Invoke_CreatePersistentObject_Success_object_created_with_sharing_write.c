...
int main(void)
{
    ...
    {
        TEEC_Error("Invoke_CreatePersistentObject_Success_object_created_with_sharing_write is failed!\n");
        goto error;
    }
    printf("Invoke_CreatePersistentObject_Success_object_created_with_sharing_write is successful!\n");
