...
TEEC_Result Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DH_KEYPAIR(void)
{
 ...
 int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DH_KEYPAIR())
    {
        TEEC_Error("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DH_KEYPAIR is Failed!\n");
        goto error;
    }
    printf("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DH_KEYPAIR is Successful!\n");
