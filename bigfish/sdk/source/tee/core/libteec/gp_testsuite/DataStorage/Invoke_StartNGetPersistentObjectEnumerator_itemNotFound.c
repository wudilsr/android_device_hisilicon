...
int main(void)
{
    ...
    {
        TEEC_Error("Invoke_StartNGetPersistentObjectEnumerator_itemNotFound is failed\n");
        goto error;
    }
    printf("Invoke_StartNGetPersistentObjectEnumerator_itemNotFound is successful!\n");
