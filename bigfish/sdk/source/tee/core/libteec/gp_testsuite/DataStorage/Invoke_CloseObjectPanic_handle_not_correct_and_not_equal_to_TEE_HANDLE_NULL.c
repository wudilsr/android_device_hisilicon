...
TEEC_Result Invoke_CloseObjectPanic_handle_not_correct_and_not_equal_to_TEE_HANDLE_NULL(void)
{
    TEEC_Result result;
...
int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_CloseObjectPanic_handle_not_correct_and_not_equal_to_TEE_HANDLE_NULL())
    {
        TEEC_Error("Invoke_CloseObjectPanic_handle_not_correct_and_not_equal_to_TEE_HANDLE_NULL is Failed!\n");
        goto error;
    }
	printf("Invoke_CloseObjectPanic_handle_not_correct_and_not_equal_to_TEE_HANDLE_NULL is Successful!\n");
