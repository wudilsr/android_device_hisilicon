...
TEEC_Result Invoke_InitValueAttribute_success(void)
{
...
int main(void)
{
    ...
    //start test
    if((result= Invoke_InitValueAttribute_success()) != 0)
    {
        TEEC_Error("Invoke_InitValueAttribute_success is failed!\n");
        goto error;
    }
    printf("Invoke_InitValueAttribute_success is successful!\n");
