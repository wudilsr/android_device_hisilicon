...
TEEC_Result Invoke_RestrictObjectUsagePanic_object_is_not_a_valid_opened_object_handle(void)
{
    TEEC_Result result;
...
//start test
    ...
    if(TEEC_SUCCESS != Invoke_RestrictObjectUsagePanic_object_is_not_a_valid_opened_object_handle())
    {
        TEEC_Error("Invoke_RestrictObjectUsagePanic_object_is_not_a_valid_opened_object_handle is Failed!\n");
        goto error;
    }
    printf("Invoke_RestrictObjectUsagePanic_object_is_not_a_valid_opened_object_handle is Successful!\n");
