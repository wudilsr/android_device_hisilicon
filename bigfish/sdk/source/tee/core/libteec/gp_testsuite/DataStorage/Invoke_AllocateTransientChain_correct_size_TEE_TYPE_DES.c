...
TEEC_Result Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DES(void)
{
 ...
 int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DES())
    {
        TEEC_Error("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DES is Failed!\n");
        goto error;
    }
    printf("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DES is Successful!\n");
