...
TEEC_Result Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DES3(void)
{
 ...
 int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DES3())
    {
        TEEC_Error("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DES3 is Failed!\n");
        goto error;
    }
    printf("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_DES3 is Successful!\n");
