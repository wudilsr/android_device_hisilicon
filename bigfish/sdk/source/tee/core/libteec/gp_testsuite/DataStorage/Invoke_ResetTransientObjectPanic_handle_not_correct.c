...
TEEC_Result Invoke_ResetTransientObjectPanic_handle_not_correct(void)
{
    TEEC_Result result;
...
int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_ResetTransientObjectPanic_handle_not_correct())
    {
        TEEC_Error("Invoke_ResetTransientObjectPanic_handle_not_correct is Failed!\n");
        goto error;
    }
    printf("Invoke_ResetTransientObjectPanic_handle_not_correct is Successful!\n");
