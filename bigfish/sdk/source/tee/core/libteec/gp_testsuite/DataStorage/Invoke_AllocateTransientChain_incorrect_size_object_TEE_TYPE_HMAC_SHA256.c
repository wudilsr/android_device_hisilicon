...
TEEC_Result Invoke_AllocateTransientChain_incorrect_size_object_TEE_TYPE_HMAC_SHA256(void)
{
 ...
 int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_AllocateTransientChain_incorrect_size_object_TEE_TYPE_HMAC_SHA256())
    {
        TEEC_Error("TestCase Invoke_AllocateTransientChain_incorrect_size_object_TEE_TYPE_HMAC_SHA256 is Failed!\n");
        goto error;
    }
    printf("TestCase Invoke_AllocateTransientChain_incorrect_size_object_TEE_TYPE_HMAC_SHA256 is Successful!\n");
