...
TEEC_Result Invoke_CreatePersistentObject_Success_object_created_with_access_write_meta(void)
{
...
int main(void)
{
    ...
    if((result= Invoke_CreatePersistentObject_Success_object_created_with_access_write_meta()) != 0)
    {
        TEEC_Error("Invoke_CreatePersistentObject_Success_object_created_with_access_write_meta is failed\n");
        goto error;
    }
    printf("Invoke_CreatePersistentObject_Success_object_created_with_access_write_meta is successful!\n");
