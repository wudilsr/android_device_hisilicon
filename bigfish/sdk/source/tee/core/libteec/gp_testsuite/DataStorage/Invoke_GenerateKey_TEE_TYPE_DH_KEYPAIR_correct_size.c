...
TEEC_Result Invoke_GenerateKey_TEE_TYPE_DH_KEYPAIR_correct_size(TEEC_Context*  context)
{
    ...
    //attribute 1
    uint32_t attrID1 = TEE_ATTR_DH_PRIME  ;
    char *attrbuff_addr1;
    attrbuff_addr1 = TEE_ATTR_DH_PRIME_VALUE01;
...
int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_GenerateKey_TEE_TYPE_DH_KEYPAIR_correct_size(&context))
    {
        TEEC_Error("Invoke_GenerateKey_TEE_TYPE_DH_KEYPAIR_correct_size is failed!\n");
        goto error;
    }
    printf("Invoke_GenerateKey_TEE_TYPE_DH_KEYPAIR_correct_size is successful!\n");
