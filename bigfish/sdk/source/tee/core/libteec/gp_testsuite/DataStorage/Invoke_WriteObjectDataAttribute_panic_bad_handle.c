...
TEEC_Result Invoke_WriteObjectDataAttribute_panic_bad_handle(void)
{
...
int main(void)
{
    ...
    if((result= Invoke_WriteObjectDataAttribute_panic_bad_handle()) != 0)
    {
        TEEC_Error("Invoke_WriteObjectDataAttribute_panic_bad_handle is Failed!\n");
        goto error;
    }
    printf("Invoke_WriteObjectDataAttribute_panic_bad_handle is Successful!\n");
