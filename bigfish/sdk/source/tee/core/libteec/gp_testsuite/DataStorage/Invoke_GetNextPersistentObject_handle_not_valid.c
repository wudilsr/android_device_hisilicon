...
//testcase No.28
TEEC_Result Invoke_GetNextPersistentObject_handle_not_valid(void)
{
...
int main(void)
{
    ...
    if((result= Invoke_GetNextPersistentObject_handle_not_valid()) != 0)
    {
        TEEC_Error("Invoke_GetNextPersistentObject_handle_not_valid is Failed!\n");
        goto error;
    }
    printf("Invoke_GetNextPersistentObject_handle_not_valid is Successful!\n");
