...
int main(void)
{
    ...
    {
        TEEC_Error("Invoke_OpenPersistentObject_Success_object_created_with_access_share_read is failed!\n");
        goto error;
    }
    printf("Invoke_OpenPersistentObject_Success_object_created_with_access_share_read is successful!\n");
