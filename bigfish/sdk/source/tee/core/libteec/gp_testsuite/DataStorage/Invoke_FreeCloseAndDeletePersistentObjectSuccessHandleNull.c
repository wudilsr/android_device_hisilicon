...
int main(void)
{
    ...
    {
        TEEC_Error("Invoke_FreeCloseAndDeletePersistentObjectSuccessHandleNull is failed!\n");
        goto error;
    }
    printf("Invoke_FreeCloseAndDeletePersistentObjectSuccessHandleNull is successful!\n");
