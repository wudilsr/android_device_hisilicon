...
TEEC_Result Invoke_AllocateTransientChain_correct_size_TEE_TYPE_HMAC_SHA512(void)
{
 ...
 int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_AllocateTransientChain_correct_size_TEE_TYPE_HMAC_SHA512())
    {
        TEEC_Error("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_HMAC_SHA512 is Failed!\n");
        goto error;
    }
    printf("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_HMAC_SHA512 is Successful!\n");
