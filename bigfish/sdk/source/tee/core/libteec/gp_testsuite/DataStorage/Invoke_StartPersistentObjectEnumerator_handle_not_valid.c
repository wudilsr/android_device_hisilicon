...
//testcase No.27
TEEC_Result Invoke_StartPersistentObjectEnumerator_handle_not_valid(void)
{
...
int main(void)
{
    ...
    if((result= Invoke_StartPersistentObjectEnumerator_handle_not_valid()) != 0)
    {
        TEEC_Error("Invoke_StartPersistentObjectEnumerator_handle_not_valid is Failed!\n");
        goto error;
    }
    printf("Invoke_StartPersistentObjectEnumerator_handle_not_valid is Successful!\n");
