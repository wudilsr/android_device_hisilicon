...
TEEC_Result Invoke_AllocateTransientChain_correct_size_TEE_TYPE_AES(void)
{
 ...
 int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_AllocateTransientChain_correct_size_TEE_TYPE_AES())
    {
        TEEC_Error("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_AES is Failed!\n");
        goto error;
    }
    printf("TestCase Invoke_AllocateTransientChain_correct_size_TEE_TYPE_AES is Successful!\n");
