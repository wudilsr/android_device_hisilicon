...
//testcase No.23
TEEC_Result Invoke_CloseAndDeletePersistentObjectPanic_object_is_not_a_valid_opened_object_handle(void)
{
...
int main(void)
{
    ...
    //start test
    if((result= Invoke_CloseAndDeletePersistentObjectPanic_object_is_not_a_valid_opened_object_handle()) != 0)
    {
        TEEC_Error("Invoke_CloseAndDeletePersistentObjectPanic_object_is_not_a_valid_opened_object_handle is Failed!\n");
        goto error;
    }
    printf("Invoke_CloseAndDeletePersistentObjectPanic_object_is_not_a_valid_opened_object_handle is Successful!\n");
