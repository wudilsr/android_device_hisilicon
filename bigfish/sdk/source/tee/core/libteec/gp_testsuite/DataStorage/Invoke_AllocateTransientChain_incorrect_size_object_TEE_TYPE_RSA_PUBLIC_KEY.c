...
TEEC_Result Invoke_AllocateTransientChain_incorrect_size_object_TEE_TYPE_RSA_PUBLIC_KEY(void)
{
 ...
 int main(void)
{
    ...
    if(TEEC_SUCCESS != Invoke_AllocateTransientChain_incorrect_size_object_TEE_TYPE_RSA_PUBLIC_KEY())
    {
        TEEC_Error("TestCase Invoke_AllocateTransientChain_incorrect_size_object_TEE_TYPE_RSA_PUBLIC_KEY is Failed!\n");
        goto error;
    }
    printf("TestCase Invoke_AllocateTransientChain_incorrect_size_object_TEE_TYPE_RSA_PUBLIC_KEY is Successful!\n");
