...
//testcase No.17
TEEC_Result Invoke_OpenPersistentObject_ItemNotFound_storageID_not_found(void)
{
...
int main(void)
{
    ...
    if((result= Invoke_OpenPersistentObject_ItemNotFound_storageID_not_found()) != 0)
    {
        TEEC_Error("Invoke_OpenPersistentObject_ItemNotFound_storageID_not_found is failed\n");
        goto error;
    }
    printf("Invoke_OpenPersistentObject_ItemNotFound_storageID_not_found is successful!\n");
