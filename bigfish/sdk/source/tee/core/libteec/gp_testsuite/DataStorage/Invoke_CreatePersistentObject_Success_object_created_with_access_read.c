...
TEEC_Result Invoke_CreatePersistentObject_Success_object_created_with_access_read(void)
{
...
int main(void)
{
    ...
    if((result= Invoke_CreatePersistentObject_Success_object_created_with_access_read()) != 0)
    {
        TEEC_Error("Invoke_CreatePersistentObject_Success_object_created_with_access_read is failed\n");
        goto error;
    }
    printf("Invoke_CreatePersistentObject_Success_object_created_with_access_read is successful!\n");
