...
TEEC_Result Invoke_SeekObjectDataAttribute_panic_bad_handle(void)
{
...
int main(void)
{
    ...
    //start test
    if((result= Invoke_SeekObjectDataAttribute_panic_bad_handle()) != 0)
    {
        TEEC_Error("Invoke_SeekObjectDataAttribute_panic_bad_handle is Failed!\n");
        goto error;
    }
    printf("Invoke_SeekObjectDataAttribute_panic_bad_handle is Successful!\n");
