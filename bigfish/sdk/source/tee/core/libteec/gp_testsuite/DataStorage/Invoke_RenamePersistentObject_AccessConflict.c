...
TEEC_Result Invoke_RenamePersistentObject_AccessConflict (void)
{
...
int main(void)
{
    ...
    if((result= Invoke_RenamePersistentObject_AccessConflict ()) != 0)
    {
        TEEC_Error("Invoke_RenamePersistentObject_AccessConflict is failed!\n");
        goto error;
    }
    printf("Invoke_RenamePersistentObject_AccessConflict is successful!\n");
