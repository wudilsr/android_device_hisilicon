...
int main(void)
{
    ...
    TEEC_UUID uuid = { 0x534D4152, 0x5443, 0x534C, { 0x4D, 0x4C, 0x54, 0x49, 0x4E, 0x53, 0x54, 0x43 } };
    TEEC_Result result;
...
#define TEST_BUFF_SIZE 64
    ...
    memcpy(test_in_buff, "This is a TTA TCF Multiple Instace TA Test!", sizeof("This is a TTA TCF Multiple Instace TA Test!"));
    operation.started = 1;
    ...
    if(result == TEEC_SUCCESS)
        printf("TTA_TCF_MultipleInstanceTA test success\n");
