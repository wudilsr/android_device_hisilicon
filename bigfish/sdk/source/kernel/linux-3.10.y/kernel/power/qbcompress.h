...
struct compress_wrapper {
	const char *name;
	int type;
	int (*compress)(unsigned char *dst, size_t *dstlen, unsigned char *src, size_t srclen, int factor, void *extra);
	int (*decompress)(unsigned char *dst, size_t *dstlen, unsigned char *src, size_t srclen, void *extra);
};
