...
// History       :  fangqiubin 00179307 2014-10-09 Create file
//******************************************************************************
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    key0_gpio_sel         : 1   ; /* [4]  */
        unsigned int    por_gpio_sel          : 2   ; /* [6..5]  */
        unsigned int    rst_gpio_sel          : 2   ; /* [8..7]  */
        unsigned int    ir_gpio_sel           : 1   ; /* [9]  */
        unsigned int    ci_gpio_sel           : 2   ; /* [11..10]  */
