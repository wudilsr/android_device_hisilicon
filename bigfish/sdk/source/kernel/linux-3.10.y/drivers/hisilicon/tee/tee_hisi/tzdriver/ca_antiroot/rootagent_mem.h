 ...
 *
 * @brief: This function free the memory created by rm_mem_init.
 *
 * @attention: Two memory blocks are persistent,but sometime you should consider to free them.
 *
 * @param: void
 *
 * @retval: void
 ...
 *
 * @brief: This function initial two TEEC_SharedMemory structures for communication with TEE.
 *
 * @attention: null
 *
