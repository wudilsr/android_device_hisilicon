 ...
 *
 * @brief: This function initial TEE environment(context, session), create two share memory, 
 ...
 *
 * @brief: This function set the white information which is used to do check operations into the TEE environment  
 *
 * @attention: When Linux kernel start up, The function should be invoked after root_monitor_tee_init, but before other functions.
 *
 ...
 *
 * @brief: This function request a challenge generated by TEE environment, According to the challenge, 
