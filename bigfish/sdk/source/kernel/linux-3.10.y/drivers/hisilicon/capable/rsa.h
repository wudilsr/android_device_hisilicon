 ...
 *                 is not supported.
 */
int hicap_rsa_init(rsa_context *ctx, int padding, int hash_id);
 ...
 */
int hicap_rsa_public(rsa_context *ctx,
 ...
 *                 enough (eg. 128 bytes if RSA-1024 is used).
 */
int hicap_rsa_private(rsa_context *ctx,
                 const unsigned char *input,
                 unsigned char *output);
 ...
 */
int hicap_rsa_pkcs1_encrypt(rsa_context *ctx,
                       int (*f_rng)(void *),
                       void *p_rng,
                       int mode, int  ilen,
                       const unsigned char *input,
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
int hicap_rsa_pkcs1_sign(rsa_context *ctx,
                    int mode,
                    int hash_id,
                    int hashlen,
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
int hicap_rsa_pkcs1_verify(rsa_context *ctx,
                      int mode,
                      int hash_id,
                      int hashlen,
                      const unsigned char *hash,
