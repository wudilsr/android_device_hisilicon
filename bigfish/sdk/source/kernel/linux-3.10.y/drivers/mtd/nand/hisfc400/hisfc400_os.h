...
#  define CONFIG_HISFC400_REG_BASE_ADDRESS            (0xF9940000)
...
#  define CONFIG_HISFC400_BUFFER_BASE_ADDRESS         (0xFC000000)
...
#  define CONFIG_HISFC400_PERIPHERY_REGBASE           (0xF8A22000)
