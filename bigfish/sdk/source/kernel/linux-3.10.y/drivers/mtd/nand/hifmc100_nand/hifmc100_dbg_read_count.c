...
struct hifmc100_dbg_read_count_t {
...
static struct hifmc100_dbg_read_count_t *dbg_read_count = NULL;
/*****************************************************************************/
				 ...
				 size_t sz_usrbuf, loff_t *ppos)
{
	...
	char *buf;
	unsigned int *pages;
	struct hifmc100_dbg_read_count_t *read_count =
		(struct hifmc100_dbg_read_count_t *)filp->private_data;
...
static int dbgfs_read_count_init(struct dentry *root, struct hifmc_host *host)
{
	int size;
	struct hifmc100_dbg_read_count_t *read_count;
	...
	size = sizeof(struct hifmc100_dbg_read_count_t);
	...
	read_count->dbgfs_name = (char *)hifmc100_dbg_inf_read_count.name;
...
static int dbgfs_read_count_uninit(struct hifmc_host *host)
{
	if (!dbg_read_count)
		return 0;
...
static void dbg_read_count_read(struct hifmc_host *host)
{
...
struct hifmc100_dbg_inf_t hifmc100_dbg_inf_read_count = {
	"read_count", 0,
