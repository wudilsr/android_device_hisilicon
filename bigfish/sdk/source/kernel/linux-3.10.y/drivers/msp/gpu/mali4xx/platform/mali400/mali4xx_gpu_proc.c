...
extern int			gpu_dvfs_set_voltage(unsigned int voltage);
extern int			gpu_dvfs_set_freq(unsigned int freq);
extern unsigned int gpu_dvfs_get_voltage(void);
extern unsigned int gpu_dvfs_get_freq(void);
extern void			gpu_avs_enable(unsigned int enable);
