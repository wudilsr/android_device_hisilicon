...
3bRFxY8PnwzsOk0c+uAmjSskaWld6uARhX7Pq5CkFAhQs87cBKDNhdDqmTxvR1+ib1UpHtnC
I5kDIiQfRzrI2M62oWsJ2dSs+RqmDQCCA9VFVAVhaCeQZn5Eo/cbjLIbo4ACiw==#*/
...
HI_S32 VPSS_STTINFO_DieInit(VPSS_DIESTINFO_S* pstDieStInfo, HI_U32 u32Width, HI_U32 u32Heigth)
{
    ...
    memset((HI_U8*)pstDieStInfo->stMMZBuf.u32StartVirAddr,0,pstDieStInfo->stMMZBuf.u32Size);
...
HI_S32 VPSS_STTINFO_CcclInit(VPSS_CCCLCNTINFO_S* pstCcclCntInfo, HI_U32 u32Width, HI_U32 u32Heigth)
{
    ...
    memset((HI_U8*)pstCcclCntInfo->stMMZBuf.u32StartVirAddr,0,pstCcclCntInfo->stMMZBuf.u32Size);
...
HI_S32 VPSS_STTINFO_NrInit(VPSS_NRMADINFO_S* pstNrMadInfo, VPSS_NR_ATTR_S* pstAttr)
{
    ...
    memset((HI_U8*)pstNrMadInfo->stMMZBuf.u32StartVirAddr,0,pstNrMadInfo->stMMZBuf.u32Size);
...
HI_S32 VPSS_STTINFO_SttWbcInit(VPSS_STTWBC_S* psttWbc)
{
	...
	memset((HI_U8*)psttWbc->stMMZBuf.u32StartVirAddr, 0, VPSS_STTWBC_SIZE);
