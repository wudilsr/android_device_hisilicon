...
static inline HI_U32 CIRC_BUF_ChangeRptr(CIRC_BUF_S *pstCb, HI_U32 u32Len)
{
    ...
    {      
        ...
        {                     
           ...
           memset((HI_U32*)((HI_U32)pstCb->pu8Data+u32ReadPos), 0, u32Len);          
        }  
        else
        {
            ...
            {
                memset((HI_U32*)pstCb->pu8Data, 0, u32ReadPos);
                
                u32ReadPos = pstCb->u32Lenght + u32ReadPos - u32Len;  
                memset((HI_U32*)((HI_U32)pstCb->pu8Data+u32ReadPos), 0, pstCb->u32Lenght - u32ReadPos);                
            }
        }
    }
    else
