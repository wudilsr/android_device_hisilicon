...
HI_S32 DRV_CA_OTP_V200_SetBootMode(CA_OTP_FLASH_TYPE_E type)
{
    ...
    /*disable SelfBoot*/
    //DRV_CA_OTP_V200_DisableSelfBoot(1);
    ...
    switch (bootMode & 0x03)
    {
        ...
        case 0x01:
            *pType = CA_OTP_FLASH_TYPE_NAND;
            break;
        case 0x02:
            *pType = CA_OTP_FLASH_TYPE_SD;
            break;
        case 0x03:
            *pType = CA_OTP_FLASH_TYPE_EMMC;
            break;
//        default:
...
HI_S32 DRV_CA_OTP_V200_SetSPLadderLevel(CA_OTP_KEY_LEVEL_E level)
{
    ...
    if( (1 == PVLOCK_0.bits.sp_lv_sel_lock) || (0x01 == PVLOCK_1.bits.sp_lv_sel_2_lock) )
    {
        ...
        if(HI_UNF_ADVCA_KEYLADDER_LEV2 == level)
        {
        ...
        else if(HI_UNF_ADVCA_KEYLADDER_LEV3 == level)
        {
        ...
        else if(HI_UNF_ADVCA_KEYLADDER_LEV4 == level)
        {
        ...
        else if(HI_UNF_ADVCA_KEYLADDER_LEV5 == level)
        {
...
HI_S32 DRV_CA_OTP_V200_SetOtpFuse(CA_OTP_ATTR_S *pstOtpAttr)
{
    ...
    switch(pstOtpAttr->enOtpFuseId)
    {
	    ...
	    case HI_UNF_ADVCA_OTP_DCAS_KL_DEACTIVATION:
	        ...
	        ret = DRV_CA_OTP_V200_SetDcasKLDisable(HI_TRUE);
	        break;
	    ...
	    case HI_UNF_ADVCA_OTP_GLOBAL_LOCK_ACTIVATION: 
	        ...
	        ret = DRV_CA_OTP_V200_SetOtpGlobalLockEn(HI_TRUE);
	        break;
