...
static unsigned long hiwdt_readl(unsigned int u32wdgIndex, unsigned int u32offset)
{
    ...
    if (u32wdgIndex < WDG_MAX_NUM)
    {
        ...
        value = readl((void *)IO_ADDRESS(u32RegAddr));
    }
...
static void hiwdt_writel(unsigned long value, unsigned int u32wdgIndex, unsigned int u32offset)
{
    ...
    {
        unsigned int u32RegAddr = g_au32RegBase[u32wdgIndex] + u32offset;
        writel(value,(void *)IO_ADDRESS(u32RegAddr));
    }
}
...
static void hidog_reset_board(unsigned int wdgindex)
{
    ...
    {
        writel(0x2, (void *)IO_ADDRESS(0x1020301C));
        writel(0x1, (void *)IO_ADDRESS(0x10203030));
        writel(0x1, (void *)IO_ADDRESS(0x10203034));
        writel(0x1, (void *)IO_ADDRESS(0x1020304C));
        writel(0x1, (void *)IO_ADDRESS(0x10203050));
        writel(0x1, (void *)IO_ADDRESS(0x1020306C));
        writel(0x3, (void *)IO_ADDRESS(0x10203074));
    }
