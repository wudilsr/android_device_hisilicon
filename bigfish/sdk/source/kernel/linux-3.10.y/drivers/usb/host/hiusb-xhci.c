...
static struct resource hiusb_xhci1_res[] = {
	[0] = {
		.start  = CONFIG_HIUSB_XHCI1_IOBASE,
		.end    = CONFIG_HIUSB_XHCI1_IOBASE
			+ CONFIG_HIUSB_XHCI1_IOSIZE - 1,
		.flags  = IORESOURCE_MEM,
	},
	[1] = {
		.start  = CONFIG_HIUSB_XHCI1_IRQNUM,
		.end    = CONFIG_HIUSB_XHCI1_IRQNUM,
		.flags  = IORESOURCE_IRQ,
	},
};

static struct platform_device hiusb_xhci1_platdev = {
	.name = "hiusb-xhci",
	.id = 1,
	.dev = {
		.dma_mask = &usb_dmamask,
	...
	.num_resources = ARRAY_SIZE(hiusb_xhci1_res),
	.resource = hiusb_xhci1_res,
};
