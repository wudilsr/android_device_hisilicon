...
#define  SEC_MEM_DEBUG

#ifdef  SEC_MEM_DEBUG
#define sec_mem_dbginfo(format, arg...)        cprintf( "%s,%d: " format , __FUNCTION__, __LINE__, ## arg)
#else
#define sec_mem_dbginfo(format, arg...)
#endif

#define sec_mem_printf(format, arg...)          cprintf(" [SecMem]: " format, ##arg)

//#define CONFIG_SYS_MEM_1G           1
//#define CONFIG_SYS_MEM_2G           1
