...
typedef struct
{
    ...
    uint8_t    AlgorithmID[TEE_DK_MAX_SIZE_OF_OTHER_INFO];  /**< a unique object identifier (OID) */
    uint32_t   SizeOfAlgorithmID;                           /**< size of AlgorithmID */
    /* Public information contributed by the initiator */
    uint8_t    PartyUInfo[TEE_DK_MAX_SIZE_OF_OTHER_INFO];   /**< Public information contributed by the initiator */
    uint32_t   SizeOfPartyUInfo;                            /**< size of PartyUInfo */
    /* Public information contributed by the responder */
    uint8_t    PartyVInfo[TEE_DK_MAX_SIZE_OF_OTHER_INFO];   /**< Public information contributed by the responder */
    uint32_t   SizeOfPartyVInfo;                            /**< size of PartyVInfo */
    /* Mutually-known private information, e.g. shared information
    communicated throgh a separate channel */
    uint8_t    SuppPrivInfo[TEE_DK_MAX_SIZE_OF_OTHER_INFO]; /**< Mutually-known private information */
    uint32_t   SizeOfSuppPrivInfo;                          /**< size of SuppPrivInfo */
    /* Mutually-known public information, */
    uint8_t    SuppPubInfo[TEE_DK_MAX_SIZE_OF_OTHER_INFO];  /**< Mutually-known public information */
    uint32_t   SizeOfSuppPubInfo;                           /**< size of SuppPubInfo */
}tee_DK_OtherInfo;
#endif
/**
 * @ingroup  crypto
