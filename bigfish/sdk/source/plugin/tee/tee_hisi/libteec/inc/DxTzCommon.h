...
typedef enum {
       DX_TZ_SERVICE_DOMMAND =1,
	   DX_TZ_PLATFORM_SET_SFS_PATH		= 5,
       DX_TZ_PLATFORM_INITIALIZE_CONTEXT,
       DX_TZ_PLATFORM_FINALIZE_CONTEXT,
       DX_TZ_PLATFORM_OPEN_SESSION,
       DX_TZ_PLATFORM_CLOSE_SESSION,
       DX_TZ_PLATFORM_INIT_SECURE_CONTENT_PATH,
       DX_TZ_PLATFORM_TERMINATE_SECURE_CONTENT_PATH,
       DX_TZ_PLATFORM_SET_APP_NAME,
	DX_TZ_PLATFORM_LAST_CMD_ID
}EDxTzPlatformCommandId;
typedef enum
{
...
#ifndef DX_TZ_APPNAME
#define DX_TZ_APPNAME "scp"
#endif
...
#define DX_TZ_MAX_BUFFER_SIZE  (1023*1024)

typedef struct {
    Dx_Client_Tz_Operation operation;
    DxUint8     buffer[DX_TZ_MAX_BUFFER_SIZE];
} DxTzClientParamBuffer_t;

typedef struct {
    DxTzServiceOperation operation;
    DxUint8     buffer[DX_TZ_MAX_BUFFER_SIZE];
} DxTzServiceParamBuffer_t;
