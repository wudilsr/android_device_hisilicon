...
# reg tools: himd, himm, himc etc, for PC tool HITOOL only.
CONFIG_TOOL_REG_UART=$(CFG_HI_TOOL_REG_UART_SUPPORT)
...
# pq_debug for pq tool
CONFIG_PQ_DEBUG=$(CFG_HI_TOOL_PQ_DEBUG_SUPPORT)
...
# include mii tools
CONFIG_TOOL_MII_TOOLS=$(CFG_HI_TOOL_MIITOOLS_SUPPORT)

# include iperf tools
CONFIG_TOOL_IPERF=$(CFG_HI_TOOL_IPERF_SUPPORT)

# include sysstat(sar) tools
CONFIG_TOOL_SYSSTAT=$(CFG_HI_TOOL_SYSSTAT_SUPPORT)
