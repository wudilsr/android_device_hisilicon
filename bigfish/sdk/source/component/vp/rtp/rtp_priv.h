...
static HI_U32   RTCP_EnableNonblock(HI_S32 fd);
static HI_S32   RTCP_Create(HI_U32 u32Chn);
static HI_VOID  RTCP_Destroy(HI_U32 u32Chn);
static HI_VOID* RTP_ScheduleRtcpSend(HI_VOID* args);
static HI_VOID* RTP_ScheduleRtcpRecv(HI_VOID* args);
static HI_S32   RTP_CheckUserConfig(const RTP_ATTR_S *pstRtpAttr);
static HI_S32   RTP_FindValidChannel(const HI_HANDLE *phRTP, HI_U32 *hId);
static HI_VOID  RTP_HeaderPacket(HI_U8* pPackAddr, HI_U32 u32TimeStamp, HI_U32 u32Marker, RTP_PAYLOAD_TYPE_E enPayload,
                                 HI_U32 u32Ssrc, HI_U16 u16LastSn);
static HI_S32   RTP_RecvBufInit(HI_U32 u32Chn);
static HI_VOID  RTP_RecvBufDeInit(HI_U32 u32Chn);
static HI_S32   RTP_JudgeSeqNum(HI_U16 u16RefNum, HI_U16 u16JudgeNum);
static HI_S32   RTP_RecvBufQueueES(HI_U32 u32Chn, HI_U32 u32SeqNum, RTP_RECV_BUF_NODE_S *pstTmpBufNode);
