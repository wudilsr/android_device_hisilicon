...
#define EnterCriticalSection(x)  ((HI_VOID)pthread_mutex_lock(x))
#define LeaveCriticalSection(x)  ((HI_VOID)pthread_mutex_unlock(x))
#define InitializeCriticalSection(x)  ((HI_VOID)pthread_mutex_init(x,NULL))
#define DeleteCriticalSection(x) ((HI_VOID)pthread_mutex_destroy(x))
