...
static HI_VOID _DtvCC_DrawRowText(HI_U8 u8WindowID,HI_U16 u16StartX, HI_U16 u16StartY, HI_U8 u8Row, HI_BOOL bOffScreen)
{
    ...
    HI_U8 bClear = 2, u8ColumnBegin, u8ColumnEnd;
    HI_BOOL bIgnoreLeftBG = HI_FALSE;
    ...
    /* Set initial value */
    u8ColumnBegin = 0;
    u8ColumnEnd = MAX_CC_COLUMNS;
    s32CharCount = 0;
    s32TotalWidth = 0;
    s32MaxHeight = 0;
    s32SpaceWidth = 0;
    s32SpaceCount = 0;
    s32LastHeight = s32CurHeight = 0;
    pstCursor = &CCWindow[u8WindowID].stCursor;
