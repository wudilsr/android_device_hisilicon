...
#define DATA_BASE_ADDR (0xF840e000)
...
/* SC_GEN12, SC_GEN13, SC_GEN14 store dispMode, dispvalue and timeVal */
#define SC_GEN12   0xb0
#define SC_GEN13   0xb4
#define SC_GEN14   0xb8

/* Add for advanced CA to check if suspend happen */
#define SC_GEN15    0xbc
#define CHECK_VECTOR_BASE_ADDR (0xF840EE00)

/* use this common reg to save ddr phy reg restore address of c51  */
#define SC_GEN16  0xc0

#define DATA_CHIP      (DATA_BASE_ADDR + 0x0)
#define DATA_WDGON     (DATA_BASE_ADDR +0x04)
#define DATA_DBGMASK   (DATA_BASE_ADDR +0x08)
#define DATA_GPIO0     (DATA_BASE_ADDR +0x0c)
#define DATA_GPIO1     (DATA_BASE_ADDR +0x10)

#ifdef  HI_ADVCA_SUPPORT
#define DATA_DISPMODE  (CFG_BASE_ADDR + SC_GEN12)
#define DATA_DISPVAL   (CFG_BASE_ADDR + SC_GEN13)
#define DATA_TIMEVAL   (CFG_BASE_ADDR + SC_GEN14)
#else
#define DATA_DISPMODE  (DATA_BASE_ADDR +0x14)
#define DATA_DISPVAL   (DATA_BASE_ADDR +0x18)
#define DATA_TIMEVAL   (DATA_BASE_ADDR +0x1c)
#endif
#define DATA_KEYTYPE   (DATA_BASE_ADDR +0x20)
#define DATA_KEYVAL    (DATA_BASE_ADDR +0x24)
#define DATA_IRTYPE    (DATA_BASE_ADDR +0x28)
#define DATA_IRNUM     (DATA_BASE_ADDR +0x2c)
