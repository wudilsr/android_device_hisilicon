...
void WaitforEnterFlag(void)
{
    ...
    while (1)
    {
        ...
        read_regVal();
        value_gen = regData.val32;

         /* To support the old version flag address */
        regAddr.val32 = 0xf8407520;
        read_regVal();
        value_ram = regData.val32;

        
        if ((0x12345678 == value_gen) || (0x12345678 == value_ram))
        {
            regData.val32 = 0x0;
            write_regVal();
            break;
        ...
        if ((0x11111111 == value_gen) || (0x11111111 == value_ram))
        {
            regData.val32 = 0x0;
            write_regVal();
