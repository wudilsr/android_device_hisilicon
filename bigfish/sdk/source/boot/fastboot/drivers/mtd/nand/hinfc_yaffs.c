...
static unsigned int hinfc610_support_yaffs2[] = {
	SET_HINFC_VER(HINFC_VER_COMMON, _2K, hinfc610_ecc_none),
	SET_HINFC_VER(HINFC_VER_COMMON, _4K, hinfc610_ecc_none),
	SET_HINFC_VER(HINFC_VER_COMMON, _8K, hinfc610_ecc_none),
	SET_HINFC_VER(HINFC_VER_COMMON, _16K, hinfc610_ecc_none),
	SET_HINFC_VER(HINFC_VER_COMMON, _32K, hinfc610_ecc_none),
	0,
};

static unsigned int hisfc400_support_yaffs2[] = {
	SET_HINFC_VER(HINFC_VER_COMMON, _2K, hisfc400_ecc_none),
		...
		unsigned int length)
{
	...
	if (host_info->hostver == HINFC_VER_610) {
		...
		yaffs2tag_nandip = HINFC_VER_610;
		extern int hinfc610_ecc_reg2type_intf(int reg);
		host_eccreg = (int)hinfc610_ecc_none;
		yaffs2_tag_ecctype = hinfc610_ecc_reg2type_intf(yaffs2_tags->eccreg);
	} else
	...
	if (host_info->hostver == HISFC_VER_400) {
		...
		host_eccreg = (int)hisfc400_ecc_none;
		yaffs2_tag_ecctype = hisfc400_ecc_reg2type((enum hisfc400_ecc_reg)yaffs2_tags->eccreg);
	} else
