...
static char *hifmc100_hynix_cg_adie_otp_check(const char otp[8 * 128])
{
	int index = 0;
	int ix, jx;
	char *ptr = NULL;
...
static int hifmc100_hynix_cg_adie_eslc_enable(void *host, int enable)
{
	int ix;
	u32 regval;
...
struct read_retry_t hifmc100_hynix_cg_adie_read_retry = {
	...
	.enable_enhanced_slc = hifmc100_hynix_cg_adie_eslc_enable,
};
