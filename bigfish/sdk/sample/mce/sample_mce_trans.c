...
HI_S32 MceDispInit(HI_UNF_ENC_FMT_E enFormat)
{
    ...
    stDispIntf.unIntf.stCVBS.u8Dac = DAC_CVBS;
    HI_UNF_DISP_AttachIntf(HI_UNF_DISPLAY0, &stDispIntf, 1);

    stDispIntf.enIntfType = HI_UNF_DISP_INTF_TYPE_YPBPR;
    stDispIntf.unIntf.stYPbPr.u8DacY = DAC_YPBPR_Y;
    stDispIntf.unIntf.stYPbPr.u8DacPb = DAC_YPBPR_PB;
    stDispIntf.unIntf.stYPbPr.u8DacPr = DAC_YPBPR_PR;
    HI_UNF_DISP_AttachIntf(HI_UNF_DISPLAY1, &stDispIntf, 1);
