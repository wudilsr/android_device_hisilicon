...
#define UTI_DEFAULT_DVB_PORT 1
#else
#define UTI_DEFAULT_DVB_PORT DEFAULT_DVB_PORT
#endif
...
HI_S32 main(HI_S32 argc,HI_CHAR *argv[])
{
    ...
    {
        printf("Usage: %s freq [srate] [qamtype] [vo_format]\n"
    ...
    HI_UNF_DMX_GetTSPortAttr(UTI_DEFAULT_DVB_PORT, &stPortAttr);
    stPortAttr.enPortType  =HI_UNF_DMX_PORT_TYPE_PARALLEL_VALID;
    HI_UNF_DMX_SetTSPortAttr(1, &stPortAttr);
    #endif
    
    Ret |= HI_UNF_DMX_AttachTSPort(0,UTI_DEFAULT_DVB_PORT);
    if (HI_SUCCESS != Ret)
    {
