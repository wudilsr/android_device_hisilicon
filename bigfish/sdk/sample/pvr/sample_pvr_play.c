...
HI_S32 main(int argc, char *argv[])
{
    ...
    while (HI_FALSE == g_bIsPlayStop)
    {
        ...
        if ('f' == InputCmd[0])
        {
            ...
            u32FTimes++;
            snprintf(StatString, sizeof(StatString),"FF %dX", stTrickMode.enSpeed/HI_UNF_PVR_PLAY_SPEED_NORMAL);
        ...
        if ('s' == InputCmd[0])
        {
            ...
            u32STimes++;
            snprintf(StatString,sizeof(StatString), "SF %dX", stTrickMode.enSpeed/HI_UNF_PVR_PLAY_SPEED_NORMAL);
            DrawStatusString(StatString);
        ...
        if ('r' == InputCmd[0])
        {
            ...
            u32RTimes++;
            snprintf(StatString, sizeof(StatString),"FB %dX", stTrickMode.enSpeed/HI_UNF_PVR_PLAY_SPEED_NORMAL);
            DrawStatusString(StatString);
            continue;
        }
