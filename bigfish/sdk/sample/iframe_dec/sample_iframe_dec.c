...
HI_S32 receive_prog(HI_S32 TunerFreq,HI_S32 TunerSrate,HI_U32 ThirdParam,PMT_COMPACT_TBL **ppProgTbl)
{
    ...
    Ret = HIADP_Tuner_Connect(TUNER_USE,TunerFreq,TunerSrate,ThirdParam);
    if (HI_SUCCESS != Ret)
    {
...
HI_S32  process_picture(HI_HANDLE hLayer,HI_UNF_VIDEO_FRAME_INFO_S *pCapPic)
{
    ...
    stSurInfo.pPhyAddr[0] = (HI_CHAR*)pCapPic->stVideoFrameAddr[0].u32YAddr;
    stSurInfo.pPhyAddr[1] = (HI_CHAR*)pCapPic->stVideoFrameAddr[0].u32CAddr;
    stSurInfo.Pitch[0] = pCapPic->stVideoFrameAddr[0].u32YStride;
    stSurInfo.Pitch[1] = pCapPic->stVideoFrameAddr[0].u32YStride;
    stSurInfo.pVirAddr[0] = (HI_CHAR*)pCapPic->stVideoFrameAddr[0].u32YAddr;
    stSurInfo.pVirAddr[1] = (HI_CHAR*)pCapPic->stVideoFrameAddr[0].u32CAddr;
