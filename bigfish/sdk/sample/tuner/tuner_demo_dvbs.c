...
HI_VOID hi_tuner_setchannel(char * channel)
{
    ...
    {
        s_stConnectPara.unConnectPara.stCab.u32Freq = u32Freq * 1000;
        s_stConnectPara.unConnectPara.stCab.u32SymbolRate = u32Symb;
    }
    else if (s_stConnectPara.enSigType == HI_UNF_TUNER_SIG_TYPE_SAT)
    {
        s_stConnectPara.unConnectPara.stSat.u32Freq = u32Freq * 1000;
        s_stConnectPara.unConnectPara.stSat.u32SymbolRate = u32Symb;
        s_stConnectPara.unConnectPara.stSat.enPolar = u32Polar;
    }
    else
    {
        s_stConnectPara.unConnectPara.stTer.u32Freq = u32Freq;
...
HI_VOID hi_tuner_setlnb(char * freq)
{
    ...
    if (s_stConnectPara.enSigType == HI_UNF_TUNER_SIG_TYPE_SAT)
    {
