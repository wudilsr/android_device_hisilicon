...
HI_S32 main(HI_S32 argc, HI_CHAR *argv[])
{
    ...
    {
        printf("Usage: sample_vp_vi af_inet localIP remoteIP [vo_format]\n"
               "       af_inet: 1-ipv4|0-ipv6\n"
               "       vo_format:2160P_30|2160P_24|1080P_60|1080P_50|1080i_60|1080i_50|720P_60|[720P_50]\n"
               "Example:./sample_vp_usbcam 1 192.168.1.2 192.168.1.3 720p_50\n"
               "Example:./sample_vp_usbcam 0 fe80::228:1ff:fe19:777 fe80::228:2ff:fe19:777 720p_50\n");
        return 0;
    }
    ...
    stVPAttr.stVencAttr.enVencType = HI_UNF_VCODEC_TYPE_H264;
    ...
    stVPAttr.enDecType = HI_UNF_VCODEC_TYPE_H264;   
