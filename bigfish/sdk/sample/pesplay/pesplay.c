...
static HI_S32 Pes_Open(HI_U32 enVideoCodec, HI_U32 u32AdecTypeCodec, HI_HANDLE *ohAVHandle, HI_HANDLE *ohWin, HI_HANDLE *phTrack)
{
...
HI_S32 main(HI_S32 argc,HI_CHAR *argv[])
{
    ...
    Pes_Open(VdecType, AdecType, &hAVPlay, &hWin, &hTrack);
