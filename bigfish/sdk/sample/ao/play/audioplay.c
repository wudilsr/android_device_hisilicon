...
HI_S32 main(HI_S32 argc, HI_CHAR *argv[])
{
    ...
    for(u32Snd = 0;u32Snd < u32SndNum; u32Snd++)
    {
        pthread_create(&g_EsThd[u32Snd], HI_NULL, (HI_VOID *)AudioTthread, (HI_VOID *)u32Snd);
    }
