...
PREBUILT_PQ_PATH        := $(TOP)/device/hisilicon/$(CHIPNAME)/prebuilts/
...
EMMC_PREBUILT_PQ_IMG := $(EMMC_PRODUCT_OUT)/pq_param.bin
$(EMMC_PREBUILT_PQ_IMG) : $(EMMC_PRODUCT_OUT)/% : $(PREBUILT_PQ_PATH)/% | $(ACP)
	$(transform-prebuilt-to-target)
...
EMMC_PREBUILT_IMG := $(EMMC_CHIP_TABLE) \
		...
		$(EMMC_PREBUILT_PQ_IMG)

$(EMMC_PREBUILT_IMG) : $(EMMC_CHIP_TABLE) $(EMMC_PREBUILT_BASEPARAM_IMG) $(EMMC_PREBUILT_LOGO_IMG) $(EMMC_PREBUILT_FASTPLAY_IMG) $(EMMC_PREBUILT_PQ_IMG)
