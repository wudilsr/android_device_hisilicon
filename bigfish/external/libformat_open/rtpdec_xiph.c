                                ...
                                char *attr, char *value)
{
    ...
    if (!av_strcmp(attr, "sampling")) {
        if (!av_strcmp(value, "YCbCr-4:2:0")) {
            codec->pix_fmt = PIX_FMT_YUV420P;
        } else if (!av_strcmp(value, "YCbCr-4:4:2")) {
            codec->pix_fmt = PIX_FMT_YUV422P;
        } else if (!av_strcmp(value, "YCbCr-4:4:4")) {
    ...
    } else if (!av_strcmp(attr, "width")) {
        /* This is an integer between 1 and 1048561
         * and MUST be in multiples of 16. */
        codec->width = atoi(value);
        return 0;
    } else if (!av_strcmp(attr, "height")) {
        /* This is an integer between 1 and 1048561
         * and MUST be in multiples of 16. */
        codec->height = atoi(value);
        return 0;
    } else if (!av_strcmp(attr, "delivery-method")) {
        /* Possible values are: inline, in_band, out_band/specific_name. */
        return AVERROR_PATCHWELCOME;
    } else if (!av_strcmp(attr, "configuration-uri")) {
        ...
        return AVERROR_PATCHWELCOME;
    } else if (!av_strcmp(attr, "configuration")) {
