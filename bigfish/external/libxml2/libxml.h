...
//must be identical with those defined in libdash::error.h
#define HISIURL_END                 "?HiSiUrlEnd"
#define HISIURL_HTTPHEADERS  "HiSiHTTPHeaders="

#define HIPLAYER_LOG_ENV  "HIPLAYER_LOG_LEVEL"
#define HIPLAYER_ENV_LOG_LEVEL_QUIET    "QUIET"
#define HIPLAYER_ENV_LOG_LEVEL_ERROR   "ERROR"
#define HIPLAYER_ENV_LOG_LEVEL_INFO     "INFO"
#define HIPLAYER_ENV_LOG_LEVEL_WARN   "WARNING"
