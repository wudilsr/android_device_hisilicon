        ...
        namespace mpd
        {
            ...
            class IRepresentationStream
            {
                public:
                    ...
                    virtual uint64_t                    GetSegmentEndTime  (uint32_t position) = 0;
                    virtual uint64_t                    GetSegmentStartTime  (uint32_t position) = 0;
                    virtual uint32_t                    GetPositionFromTime  (int64_t ms, int direct) = 0;
            };
        }
    }
}
