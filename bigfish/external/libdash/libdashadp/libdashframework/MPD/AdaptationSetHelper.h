        ...
        namespace mpd
        {
            class AdaptationSetHelper
            {
                public:
                    ...
                    static std::vector<dash::mpd::IAdaptationSet *> GetSubtitleAdaptationSets  (dash::mpd::IPeriod *period);
                    ...
                    static bool                                     IsSubTitleAdaptationSet    (dash::mpd::IAdaptationSet *adaptationSet);
            };
        }
    }
}
