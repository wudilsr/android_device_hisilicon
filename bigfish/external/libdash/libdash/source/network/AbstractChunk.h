    ...
    namespace network
    {
        class AbstractChunk : public virtual IDownloadableChunk
        {
            public:
                ...
                virtual bool    StartDownload           (void *easyHandle, void *multiHandle);
                ...
                void NotifyDownloadBytes(DownloadInfo &info);
                /*
                 * IDASHMetrics
                 */
