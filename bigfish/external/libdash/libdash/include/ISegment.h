    ...
    namespace mpd
    {
        class ISegment : public virtual network::IDownloadableChunk
        {
            public:
                ...
                /**
                 *  This method allows you to get absolute URI for this Segment
                 *  it is also defined in AbstractChunk.h as a virtual function
                 *  @return value      uri     a string representing an URI
                 */
