    ...
    namespace network
    {
        class IDownloadableChunk : public IChunk, public dash::metrics::IDASHMetrics
        {
            public:
                ...
                /**
                 *  Starts the download of this chunk and returns a bool value whether the starting of the download was possible or not
                 *  @param      easyHandle     curl easy handle created outside that shall be used for downloading
                 *  @param      multiHandle    curl multi handle created outside that shall be used for downloading
                 *  @return     a bool value
                 */
                virtual bool    StartDownload           (void *easyHandle, void *multiHandle)   = 0;
                /**
