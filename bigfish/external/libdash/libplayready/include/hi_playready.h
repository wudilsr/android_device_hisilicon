...
#define PLAYREADY_ENV_LOCALSTORE	"/data/playready/prdata.localstore\0"
#define PLAYREADY_ENV_CERT_PATH	"/data/playready/prpd/"
#define PLAYREADY_ENV_KEYFILE_PATH  "/data/playready/"
...
typedef struct 
{
    HI_CHAR szCertPath[256];
    HI_CHAR szKeyFilePath[256];
    HI_CHAR szLocalStorePath[256];
    HI_BOOL	bCertEncrypted;
...
typedef struct
{
	HI_U8 	m_oAccountID[16];
	HI_U8   m_oServiceID[16];
	HI_U32           	      m_dwRevision;
...
only for debug
*/
void dbg_printData(char * title, unsigned char * buffer, unsigned int length);
int dbg_store2file(char * filename, unsigned char *pu8Data, unsigned int length);

/**
\brief Get playready config attributes, initialize device certification buffers, initialize drm library.
*/
HI_S32 HI_PLAYREADY_Init(void);
HI_S32 HI_PLAYREADY_DeInit(void);
...
\see \n
*/
HI_U32 HI_PLAYREADY_Open(HI_PLAYREADY_OPENPARAM_S *pOpenParam, HI_PLAYREADY_Handle *handle);
...
\see \n
*/
HI_U32 HI_PLAYREADY_OpenEx(HI_PLAYREADY_OPENPARAMEx_S *pOpenParamEx, HI_PLAYREADY_Handle *handle);

/**
\brief close PlayReady handle£¬release the resources.
\attention \n
\param[in] handle   the PlayReady handle will be released
...
none
*/
HI_U32 HI_PLAYREADY_SetCumtomData(HI_PLAYREADY_Handle handle, 
...
none
*/
HI_U32 HI_PLAYREADY_LicAcquisition_Generate_Challenge(HI_PLAYREADY_Handle handle, HI_PLAYREADY_CHALLENGE_S *pChallenge);
...
none
*/
HI_U32 HI_PLAYREADY_LicAcquisition_Generate_ChallengeEx(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING stCustomerData, HI_PLAYREADY_CHALLENGE_S *pChallenge);

/**
\brief process the response returned by the server and store this license
\attention \n
\param[in]  handle  PlayReady handle
\param[out] pResponse  data returned by the server £¬see details in::HI_PLAYREADY_ASCII_STRING
...
HI_U32 HI_PLAYREADY_LicAcquisition_ProcessResponse(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING *pResponse, HI_PLAYREADY_LICENSE_RESPONSE *pAckResponse);     
/**
...
none
*/
HI_S32 HI_PLAYREADY_GetLicenseStatusEx(HI_PLAYREADY_Handle handle, HI_PLAYREADY_LICENSE_STATICS_STATUS_S *pstStaticStatus);
...
none
*/
HI_U32 HI_PLAYREADY_GetOPLStatus(HI_PLAYREADY_Handle handle, HI_PLAYREADY_OPLs_S *oplPolicy);
/**
...
none
*/
HI_U32 HI_PLAYREADY_Decrypt(HI_PLAYREADY_Handle handle, HI_PLAYREADY_DECRYPTPARM_S *pDecryptParam);
/**
\brief generates a domain join challenge to be sent to the domain registration server to register a device to a domain
\attention \n
*/
HI_U32 HI_PLAYREADY_JoinDomain_Generate_Challenge(HI_PLAYREADY_Handle handle, HI_DOMAINID_PARAM_S *pDomainParam, HI_PLAYREADY_CHALLENGE_S *pChallenge);
/**
\brief processes a domain join response received from the domain registration server
\attention \n
*/
HI_U32 HI_PLAYREADY_JoinDomain_ProcessResponse(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING *pResponse);
/**
...
\attention \n
*/
HI_U32 HI_PLAYREADY_LeaveDomain_Generate_Challenge(HI_PLAYREADY_Handle handle, HI_DOMAINID_PARAM_S *pDomainParam, HI_PLAYREADY_CHALLENGE_S *pChallenge);
/**
\brief processes a domain leave response received from the domain registration server.
*/
HI_U32 HI_PLAYREADY_LeaveDomain_ProcessResponse(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING *pResponse);
/**
\brief Decode a DomainID from Base64
*/
HI_U32 HI_PLAYREADY_B64_To_DomainID(HI_U8* serviceID, HI_U8* accountID, HI_U32 u32Revision, HI_PLAYREADY_DOMAINID_S *DomainID);
/**
\brief Decode a DomainID from Base64
*/
HI_U32 HI_PLAYREADY_GetResponseData(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING *pResponse, HI_RESPONSE_DATATYPE_E DataType, HI_PLAYREADY_ASCII_STRING *pDataString);
/**
\brief Parse the web initiators to get the data
*/
HI_U32 HI_PLAYREADY_Generate_InitiatorData(HI_PLAYREADY_ASCII_STRING webInitiators, HI_PLAYREADY_INITIATOR_DATA **pInitiatorData, HI_U32 *number);
/**
\brief Parse the web initiators to get the data
*/
HI_U32 HI_PLAYREADY_Release_InitiatorData(HI_PLAYREADY_INITIATOR_DATA **pInitiatorData, HI_U32 number);
/**
...
*/
HI_U32 HI_PLAYREADY_MeterCert_Generate_Challenge(HI_PLAYREADY_Handle handle, HI_PLAYREADY_INITIATOR_DATA pData, HI_PLAYREADY_CHALLENGE_S *pChallenge);
/**
...
*/
HI_U32 HI_PLAYREADY_MeterCert_ProcessResponse(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING *pResponse);
/**
\brief find the MeterCert by MID
*/
HI_U32 HI_PLAYREADY_FindMeterCertByMID(HI_PLAYREADY_Handle handle, HI_U8 MID[16], HI_PLAYREADY_ASCII_STRING *pMeterCert);
/**
...
*/
HI_U32 HI_PLAYREADY_Metering_Generate_Challenge(HI_PLAYREADY_Handle handle, HI_PLAYREADY_CHALLENGE_S *pChallenge, HI_PLAYREADY_ASCII_STRING *pMeterCert);
/**
...
*/
HI_U32 HI_PLAYREADY_Metering_ProcessResponse(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING *pResponse);

HI_U32 HI_PLAYREADY_GetSecureClock(HI_PLAYREADY_Handle handle, HI_PLAYREADY_SECURECLOCK_STATUS_E  *penStatus,  HI_PLAYREADY_DATE_TIME_S *pstTime);
...
*/
HI_U32 HI_PLAYREADY_SecureClock_Generate_Challenge(HI_PLAYREADY_Handle handle,  HI_PLAYREADY_CHALLENGE_S *pChallenge);
/**
...
*/
HI_U32 HI_PLAYREADY_SecureClock_ProcessResponse(HI_PLAYREADY_Handle handle,  HI_PLAYREADY_ASCII_STRING *pResponse);
/**
...
*/
HI_U32 HI_PLAYREADY_MeterCert_Invalidate(HI_PLAYREADY_Handle handle, HI_U8 MID[16]);
...
*/
HI_U32 HI_PLAYREADY_MeterCert_Update(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING *pMeterCert, HI_U8 MID[16]);
...
*/
HI_U32 HI_PLAYREADY_MeterCert_Delete(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING *pMeterCert, HI_U8 MID[16]);
/**
\brief it generates a license acquisition acknowledge challenge
*/
HI_U32 HI_PLAYREADY_LicenseAcq_Generate_Ack(HI_PLAYREADY_Handle handle, HI_PLAYREADY_LICENSE_RESPONSE *pLicResponse, HI_PLAYREADY_CHALLENGE_S *pChallenge, HI_U8 *URL);
/**
\brief it generates a license acquisition acknowledge challenge
*/
HI_U32 HI_PLAYREADY_LicenseAcq_ProcessAckResponse(HI_PLAYREADY_Handle handle, HI_PLAYREADY_ASCII_STRING *pResponse);
/**
\brief it sets content properties used for DRM tasks
*/
HI_U32 HI_PLAYREADY_Content_SetProperty(HI_PLAYREADY_Handle handle, HI_PLAYREADY_CONTENT_SET_PROPERTY_E ePropertyType, HI_PLAYREADY_ASCII_STRING pPropertyData);
/**
...
*/
HI_U32 HI_PLAYREADY_StoreMgmt_CleanupStore(HI_PLAYREADY_Handle handle, HI_PLAYREADY_STORE_CLEANUP_E en );

/**
\brief Deletes licenses for one stream which DRM header has been setted.
*/
HI_U32 HI_PLAYREADY_StoreMgmt_DeleteLicenses(HI_PLAYREADY_Handle handle, HI_U32 *pu32LicDeleted );

/**
\brief create an envelop handle and initialize the PlayReady context
*/
HI_U32 HI_envelop_Open(HI_PLAYREADY_OPENPARAM_S *pOpenParam, HI_PLAYREADY_Handle *handle);
/**
\brief Decrypt the envelop file and store it locally  
*/
HI_U32 HI_envelop_Read(HI_PLAYREADY_Handle handle, HI_U8* outputFileName);
/**
\brief destroy the envelop handle and deinitialize the PlayReady context
*/
HI_U32 HI_envelop_Close(HI_PLAYREADY_Handle handle);
