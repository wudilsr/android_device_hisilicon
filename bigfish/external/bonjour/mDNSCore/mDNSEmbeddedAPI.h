...
struct ZoneData_struct
	...
	ZoneService      mZoneService;		// Which service we're seeking for this zone (update, query, or LLQ)
	...
	ZoneDataCallback *mZoneDataCallback;	// Caller-specified function to be called upon completion
