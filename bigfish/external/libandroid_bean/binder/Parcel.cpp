...
#define ALOG_REFS(...)
//#define ALOG_REFS(...) ALOG(ALOG_DEBUG, "Parcel", __VA_ARGS__)
                        ...
                        const flat_binder_object& obj, const void* who)
    {
        switch (obj.type)
        {
            case BINDER_TYPE_BINDER:
                if (obj.binder)
                {
                    ALOG_REFS("Parcel %p acquiring reference on local %p", who, obj.cookie);
            ...
            case BINDER_TYPE_HANDLE:
            {
                ...
                if (b != NULL)
                {
                    ALOG_REFS("Parcel %p acquiring reference on remote %p", who, b.get());
                    b->incStrong(who);
                }
                return;
            }
                        ...
                        const flat_binder_object& obj, const void* who)
    {
        switch (obj.type)
        {
            case BINDER_TYPE_BINDER:
                if (obj.binder)
                {
                    ALOG_REFS("Parcel %p releasing reference on local %p", who, obj.cookie);
            ...
            case BINDER_TYPE_HANDLE:
            {
                ...
                if (b != NULL)
                {
                    ALOG_REFS("Parcel %p releasing reference on remote %p", who, b.get());
                    b->decStrong(who);
                }
                return;
            }
