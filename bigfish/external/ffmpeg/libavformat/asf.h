...
extern const ff_asf_guid ff_asf_protection_system_identifier;
extern const ff_asf_guid ff_asf_content_protection_system_microsoft_playready;
extern const ff_asf_guid ff_asf_steamtype_playready_encrypted_command_media;
...
typedef struct {
    ...
    unsigned int     encryption_data_len;
}ASFEncryptionObj;
void* get_secret_data(AVFormatContext* s, unsigned int * len);
void* get_encryption_data(AVFormatContext* s, unsigned int * len);
typedef struct {
    void* obj;
    int (*decrypt)(void* obj, void* data, int len);
} WMDRMDecrypt;
int set_wmdrm_decrypt_obj(AVFormatContext* s, WMDRMDecrypt obj);
