...
typedef struct {
    ...
    int first_seq;              //the rtp-info return seq after seek.
...
struct RTPDemuxContext {
    ...
    unsigned out_of_order_times;
    unsigned discarded_pkts_cnt;
    unsigned total_recved_pkt_cnt;
    uint16_t out_of_order_seq;
};
