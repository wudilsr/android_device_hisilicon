...
{\
    ...
    for (i = 0; i < len - 1; i++) {\
       av_log(0, AV_LOG_INFO, " "fmtstr",", __VA_ARGS__);\
       if ((i & linebrk) == linebrk) av_log(0, AV_LOG_INFO, "\n   ");\
    }\
    av_log(0, AV_LOG_INFO, " "fmtstr"\n", __VA_ARGS__);\
}
...
#define WRITE_ARRAY(prefix, type, name)                 \
    do {                                                \
        ...
        av_log(0, AV_LOG_INFO, prefix" "#type" "#name"[%zu] = {\n",     \
               array_size);                             \
...
#define WRITE_2D_ARRAY(prefix, type, name)                              \
    do {                                                                \
        ...
        av_log(0, AV_LOG_INFO, prefix" "#type" "#name"[%zu][%zu] = {\n",                \
...
{
    av_log(0, AV_LOG_INFO, "/* This file was automatically generated. */\n");
    av_log(0, AV_LOG_INFO, "#include <stdint.h>\n");
}
