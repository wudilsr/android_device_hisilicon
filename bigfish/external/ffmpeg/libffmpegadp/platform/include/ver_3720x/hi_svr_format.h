...
typedef enum hiFORMAT_INVOKE_ID_E
{
    ...
    HI_FORMAT_INVOKE_RTMP_RECEIVEAUDIO,    /**< the command of RTMP Protocol inform server whether send audio to client or not,the parameter is ::HI_S32 * *//**< CNcommnet: rtmp 发送命令控制服务器是否发送音频流到客户端*/
    HI_FORMAT_INVOKE_RTMP_RECEIVEVIDEO,    /**< the command of RTMP Protocol inform server whether send video to client or not,the parameter is ::HI_S32 * *//**< CNcommnet: rtmp 发送命令控制服务器是否发送视频流到客户端*/
