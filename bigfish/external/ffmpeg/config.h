...
#define FFMPEG_CONFIGURATION "--target-os=linux --arch=arm --enable-cross-compile --enable-zlib --disable-stripping --disable-ffplay --disable-ffserver --disable-ffprobe --disable-avdevice --cc=./../../prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/bin/arm-eabi-gcc --cross-prefix=./../../prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/bin/arm-eabi- --nm=./../../prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/bin/arm-eabi-nm --extra-cflags='-fPIC -DANDROID -I./../../bionic/libc/arch-arm/include -I./../../bionic/libc/kernel/common -I./../../bionic/libc/kernel/common/linux -I./../../bionic/libc/kernel/arch-arm -I./../../bionic/libc/include' --disable-asm --disable-yasm --extra-ldflags='-Wl,-T,./../../prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=./../../out/target/product/godbox/obj/lib -L./../../out/target/product/godbox/obj/lib -nostdlib ./../../prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o ./../../prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl'"
...
#define CONFIG_GAPLESSPLAY_DEMUXER 1
#define CONFIG_SEAMLESSPLAY_DEMUXER 1
#define CONFIG_BLURAYPLAY_DEMUXER 1
#define CONFIG_CUELIST_DEMUXER 1
#define CONFIG_TTML_DEMUXER 0
...
#define CONFIG_HTTPSEX_PROTOCOL 1
...
#define CONFIG_HIRTP_PROTOCOL 1
#define CONFIG_TCP_PROTOCOL 1
#define CONFIG_TLS_PROTOCOL 0
#define CONFIG_TLSEX_PROTOCOL 1
#define CONFIG_UDP_PROTOCOL 1
#define CONFIG_HIUDP_PROTOCOL 1
#define CONFIG_LPCMHTTP_PROTOCOL 1
#define CONFIG_LPCMFILE_PROTOCOL 1
#define CONFIG_WEBVTT_DEMUXER 1
#define CONFIG_PLAYLIST_PROTOCOL 1
