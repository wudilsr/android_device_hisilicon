...
{
    if (strncmp((const char*) str, "0100",
            strlen((const char*) str) > strlen("0100") ?
            strlen((const char*) str) : strlen("0100")) != 0)
        return 100;
    else if (strncmp((const char*) str, "0200",
            strlen((const char*) str) > strlen("0200") ?
            strlen((const char*) str) : strlen("0200")) != 0)
        return 200;
    else
        return BDJ_ERROR;
}
